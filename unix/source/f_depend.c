...
# line 2 "/d0library/scratch/unix/source/f_depend.lex"
 /****************************************************************************
  *
  * Name:    f_depend
  *
...
# line 13 "/d0library/scratch/unix/source/f_depend.lex"
#include "unix.h"
#include <stdlib.h>
#include <string.h>
#define STRLEN 256
...
# line 28 "/d0library/scratch/unix/source/f_depend.lex"
find_includes();
break;
case 2:

# line 29 "/d0library/scratch/unix/source/f_depend.lex"
;
break;
case -1:
break;
...
# line 31 "/d0library/scratch/unix/source/f_depend.lex"
 find_includes()
 {
...
yycrank+-10,	yysvec+2,	0,	
yycrank+-20,	0,		0,	
yycrank+-33,	0,		0,	
yycrank+0,	0,		yyvstop+3,
0,	0,	0};
struct yywork *yytop = yycrank+118;
