      SUBROUTINE VTISTR(  ZIN, RIN, ZOUT, ROUT, NISA)
C----------------------------------------------------------------------
C-
...
C----------------------------------------------------------------------
      RINS2  = RIN  * RIN
      ROUTS2 = ROUT * ROUT
      IF ( LHEAD .LE. 0 ) CALL D0_ABORT(
     &                    ' **** VTISTR : LHEAD not defined')
      LISAE = LQ ( LHEAD - IZISAE )
      IF ( LISAE .LE. 0 ) CALL D0_ABORT( 
     &                    ' **** VTISTR : LISAE not defined')
C
