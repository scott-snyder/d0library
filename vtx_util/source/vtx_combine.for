...
C
        ...
        CALL EZGET_l('USE_PEAK_FOR_AREA',USE_PEAK_FOR_AREA,IER)
        IF ( .NOT. USE_PEAK_FOR_AREA ) THEN
          CALL EZGET_l('SUBTRACT_FIRST_BIN',SUBTRACT_FIRST_BIN,IER)
          CALL EZGET_i('AREA_BINS_BEFORE_PEAK',BBP,IER)
          CALL EZGET_i('AREA_BINS_AFTER_PEAK',BAP,IER)
...
C
        IF ( MCDATA ) THEN
          CALL EZGET_i('MC_VERSION',MCVERS,IER)
