...
C
          ...
          IF ( PD_INI ) CALL EZGET_i('PD_METH',PD_METH,IER)
          IF ( GN_INI ) CALL EZGET_i('GN_METH',GN_METH,IER)
          IF ( TM_INI ) CALL EZGET_i('TM_METH',TM_METH,IER)
          ...
          CALL EZGET_l('INIT_DTM', INIT_DTM, IER)
          CALL EZGET_i('MAX_VTXCRT', MAX_VTXCRT, IER)
C
