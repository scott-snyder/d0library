      SUBROUTINE FITPLE (LT,IK)
C----------------------------------------------------------------------
C-
C-   Purpose and Methods : Fill the bank TPLE: Table of "probabilities"
C-                         for pions and electrons using the LIKELIHOOD ON
C-                         TOTAL ENERGY
C-                         Has been obtained integrating the total energy
C-                         summed over 3 chambers for pions and electrons
C                          Corresponds to PRLIKETOT10 and PRLIKETOT20
