      SUBROUTINE FITPET (LT,IK)
C----------------------------------------------------------------------
C-
C-   Purpose and Methods : Fill the bank TPET: Table of "probabilities"
...
C                          Corresponds to PRETOTALE10 and PRETOTALE20
...
C        PRINT'(10F6.3)',(WS(I),I=1,IET)
   88 CONTINUE
      CLOSE (JUNIT)
C      WRITE(3,*)' DANS FITPET,NB. DE POINTS',K-LT
C      WRITE(3,'(10F7.3)')(C(LT+13+I),I=1,2*IET)
      GO TO 999
