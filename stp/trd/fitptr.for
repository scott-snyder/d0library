      SUBROUTINE FITPTR (LT,IK)
C----------------------------------------------------------------------
C-
C-   Purpose and Methods : Fill the bank TPTR: Table of "probabilities"
...
C                          Corresponds to PRETRONQU10 and PRETRONQU20
