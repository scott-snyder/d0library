      SUBROUTINE FITPC (LT,ICASE,IANG)
C----------------------------------------------------------------------
C-
C-   Purpose and Methods : Fill the bank TPCA,TPCB AND TPCC: Table of 
C-                         "probabilities" for pions and electrons using 
C-                         the TRUNCATED TOTAL ENERGY.
C-                         Has been obtained integrating the total energy
C-                         summed over 3 chambers for pions and electrons
C                          Corresponds to PRLIKECLx10 and PRLIKECLx20
C                          (50 and 90 degrees resp.) where x='A','B' or 'C'
C-                         corresponding to cluster reshold of 0,30,60 resp.
C-
...
C----------------------------------------------------------------------
      IMPLICIT NONE
      INTEGER I,ICASE,ICH,ID,IET,IANG,J,JUNIT,LT,K,KI
      INTEGER WSI(2),WSS(2)
...
C----------------------------------------------------------------------
      WRITE(CAR1,'(I1)')IANG
      DFILE = 'PRLIKECL'//CHAR1(ICASE)//CAR1//'0'
