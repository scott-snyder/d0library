...
C-       This version for STP library is temporary and should
C-       disappear as soon as possible.
C-
C-   Created  May-18-1989   Serban D. Protopopescu
C-
C----------------------------------------------------------------------
      IMPLICIT NONE
C ZEBSTP.INC
...
C
     ...
     $,  LMU(10)    ! available
C
     $,  LSVTX      ! Vertex chamber constants header
...
C
     ...
     $,  LFD(10)    ! available
C
     $,  LSCAL      ! Calorimeter constants header
