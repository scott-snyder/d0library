      SUBROUTINE CCEM_ROTATION_MATRICES
C----------------------------------------------------------------------
C-
C-   Purpose and Methods : CCEM Rotation Matrices
C-
C-      Establish rotation matrices for each CCEM module.  Positioning
...
C  Reals
      ...
      REAL ANGLE
C----------------------------------------------------------------------
C  Get the number of CCEM modules, and the angular offset of the first
