      SUBROUTINE ECPAD_MH(LCLAY, TITLE, LYR)
C----------------------------------------------------------------------
C-
C-   Purpose and Methods : TO FILL PAD INFORMATION  FROM SRCP INTO 
C-       CLAY BANK only for MH Z divisions. Format of MH is slightly
C-       different since there are two Geant daughter names
C-
...
C
      ...
      INTEGER LCLAY, JCLAY, NPHI, NETA, I
      REAL SGN, FG
C
...
C    IVAL(INDX2) => IVAL(INDX2)-1 due to modification in RCP
