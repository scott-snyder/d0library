      SUBROUTINE ECIH_SUPPORT_PIPE_GEOM
C----------------------------------------------------------------------
C-
C-   Purpose and Methods : Create ECIH Support Pipe GEANT volume
C-
C-   Inputs  : none
C-   Outputs : none
C-   Controls: none
...
C----------------------------------------------------------------------
     ...
     &  VOLUME_LABEL, LEN, IER )
      CALL EZGET_i ( 'ECIH_SUPPORT_PIPE_VOLUME_NAME', VOLUME_NAME, IER )
