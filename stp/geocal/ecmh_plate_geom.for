...
C----------------------------------------------------------------------
      ...
      CALL EZGET('ECMH_N_PHI_BOUNDS',N_PHIBOUNDS,IER)
      CALL EZGET('ECMH_PHI_BOUNDS',PHIBOUNDS,IER)
      CALL EZGET('ECMH_LAST_GAP_PER_STEP',LAST_GAP_PER_STEP,IER)
      CALL EZGET('ECMH_PLATE_MODULE_VOLUME_NAME',VOLUME_MOTHER,IER)
C----------------------------------------------------------------------
...
C-    Choose between MFH and MCH.
        IF (IGAP.GT.MFH_GAPMAX) then
          ...
          SECT='ECMCH'
        ELSE
          CALL EZGET('URANIUM_CODE',VOLUME_MATERIAL_CODE,IER)
          SECT='ECMFH'
        ENDIF
C----------------------------------------------------------------------
...
C       WRITE (*,*) 'ECMH Signal Board '//GAP
        ...
        CALL EZGET('G10_CODE',VOLUME_MATERIAL_CODE,IER)
...
C         WRITE (*,*) 'ECMH End of Step '//STEP
          ISTEP=ISTEP+1
          ARGONGAP_COPY=0
          CALL EZGET('ECMH_STEP'//STEP//'_NCELLS',N_ETABOUNDS,IER)
          CALL EZGET('ECMH_STEP'//STEP//'_CELLS',ETABOUNDS,IER)
