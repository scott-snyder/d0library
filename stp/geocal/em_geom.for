C DEC/CMS REPLACEMENT HISTORY, Element EM_GEOM.FOR
C *4    30-DEC-1988 23:23:41 RAJA "GOT RID OF VPSP"
C *3    26-DEC-1988 23:04:24 RAJA "Em geom now correct"
C *2    26-DEC-1988 11:23:00 RAJA "EM geometry routine"
C *1    26-DEC-1988 11:03:13 RAJA "EM Geometry routine"
C DEC/CMS REPLACEMENT HISTORY, Element EM_GEOM.FOR
      SUBROUTINE EM_GEOM(NAME,STRING,MOTHER,MATNO,RIN,ROUT,DELZ,ZCEN,
     &  IRTOFF,IFL)
C----------------------------------------------------------------------
C-
C-   Purpose and Methods : Works out parameters for EM tubes in CGS
C-
...
C-   Outputs : SRCP GEANT parameters for EC EM module
C-   Controls: None
C-
...
C----------------------------------------------------------------------
      ...
      INTEGER IFL
      REAL RIN,ROUT,ZCEN,DELZ,XX,YY,ZZ
      CHARACTER*(*) STRING
      CHARACTER*40 ARNAME
      CHARACTER*10 ARNAM
