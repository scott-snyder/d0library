      SUBROUTINE CCCH_ROTATION_MATRICES
C----------------------------------------------------------------------
C-
C-   Purpose and Methods : CCCH Rotation Matrices
C-
C-      Establish rotation matrices for each CCCH module.  Positioning
...
C  Reals
      ...
      REAL ANGLE
C----------------------------------------------------------------------
C  Get the number of CCCH modules, and the angular offset of the first
...
C  about the +Z axis.
C----------------------------------------------------------------------
      CALL EZGET('CCCH_NUMBER_MODULES',NUMBER_MODULES,IER)
