...
C-      Old version which follows new version in linear chain.
C-
C-   Inputs  :
C-   Outputs :
C-
C-   Created   6-JUN-1988   Jeffrey Bantly   
C-   Updated  13-AUG-1992   Robert E. Avery   Store rotation numbers
C-      for FDC units (N&S) in FGEH bank, words 9 & 10.
C-
C----------------------------------------------------------------------
      IMPLICIT NONE
...
C
      ...
      DATA XFD, YFD / 7.50, 71.12, 18.41, 0.00, 0.00, 120.01/
C-------------------------------------------------------------------
C
