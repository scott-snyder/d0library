...
C-   Updated  17-FEB-1992   Susan K. Blessing  Remove machine block for
C-    COSD and SIND, change these calculations to use radians.
C-   Updated  13-AUG-1992   Robert E. Avery  Minor cleanup.
C-   Updated  17-FEB-1993   Robert E. Avery  Add call to FSTPAR_V2,
C-                                              2nd order alignment bank
C-
C------------------------------------------------------------------------
C
      IMPLICIT NONE
