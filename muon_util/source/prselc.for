      SUBROUTINE PRSELC(UNIT,LSELC,NSELC,CFL,IFL)
C----------------------------------------------------------------------
C-
C-   Purpose and Methods : Print contents of SELC bank
C-
C-   Inputs  : UNIT  - Unit number for printout
C-             LSELC - Bank address
C-             NSELC - Module number ( if 0, print all mods )
...
C----------------------------------------------------------------------
      ...
      INTEGER UNIT,LSELC,NSELC,IFL
      CHARACTER CFL*(*)
      INTEGER I,II,LL
C
      WRITE(UNIT,100)  
  100 FORMAT('0    SAMUS MINIMUM TIMES BANK '/)
      WRITE(UNIT,101) (IC(LSELC+I),I=1,10)
101   FORMAT(' TYPE     ',I6,' STATUS   ',I6,' QUALITY       ',I6/
     ...
     A         ' SECTION NAME   ',A2,' NO. CHANNELS ',I4)
      WRITE(UNIT,102)
102   FORMAT(
     &  '  COEFFICIENT/#0  SIGMA/#0    COEFFICIENT/#1  SIGMA/#1'/)
      LL = LSELC+14
      DO I=1,IC(LSELC+10)
