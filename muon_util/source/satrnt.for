C DEC/CMS REPLACEMENT HISTORY, Element SATRNT.FOR
C *1    29-MAY-1991 16:41:24 ABACHI "OLEG EROSHIN: New SAMUS routines"
C DEC/CMS REPLACEMENT HISTORY, Element SATRNT.FOR
      SUBROUTINE SATRNT(P,STEP,VECT)  
C.  
C.    ******************************************************************    
C.    *                                                                *    
