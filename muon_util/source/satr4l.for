C+
      SUBROUTINE SATR4L (DIR, NPTMIN, NTRK, NTRMX)
C----------------------------------------------------------------------
C-
...
C----------------------------------------------------------------------
     ...
     &                   MONITOR, HADR(3,NPL)
      ...
      INTEGER N1, N2, N3, N4, J1, J2, J3, J4, L1, L2, L3, L4
      INTEGER K1, K2, K3, K4, JC1, JC2, JC3, JC4
...
C
      ...
      HADR(3,2) = LD2
      DO 203 L3 = 1, N3
      IF (IQ(LINK+J3+L3) .NE. 0) GO TO 203
      LD3 = IQ(HITS+J3+L3)
      JC3 = IQ(LD3+3)
      HADR(2,3) = L3
      HADR(3,3) = LD3
      DO 204 L4 = 1, N4
      IF (IQ(LINK+J4+L4) .NE. 0) GO TO 204
      LD4 = IQ(HITS+J4+L4)
      JC4 = IQ(LD4+3)
      HADR(2,4) = L4
      HADR(3,4) = LD4
