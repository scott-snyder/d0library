...
C----------------------------------------------------------------------
     ...
     *   TRULEN(LOCTXT).GT.10) THEN
     ...
     &         CHAR(7))
          ELSE
            I=LIBPUT(' String too LONG to be converted to integer'//
     &        CHAR(7),PBROWS-2,1,1)
          ENDIF
          I=9999999
        ELSE
     ...
     &               IC//CHAR(7))
                ELSE
                  I=LIBPUT(' Illegal character for INTEGER-->'//
     &               IC//CHAR(7),PBROWS-2,1,1)
                ENDIF
                GOTO 1002
              ELSE
 ...
 1002     CONTINUE
      ...
      ELSE
        ...
        ELSE
          I=LIBPUT(' Illegal character for INTEGER-->'//IC//CHAR(7),
     &      PBROWS-2,1,1)
        ENDIF
        TRAINT=9999999
      ENDIF
