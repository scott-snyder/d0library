...
C    General fields
      ...
      CALL EZGET('RECORD_LENGTH',LRECL,IERR)
      CALL EZGET('FIRST_EVENT',IZEVT1,IERR)
      CALL EZGET('LAST_EVENT',IZEVTN,IERR)
      CALL EZGET('EVENTS',NEVTS,IERR)
C    Output-type-specific fields
      IF( FZTYPE(1:3).EQ.'STA' ) THEN
         ...
         CALL EZGET('FILE_SEQUENCE_NUMBER',IFSN,IERR)
