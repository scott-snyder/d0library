...
C
      INTEGER NHITS,K1,K2,KK,L
      INTEGER PRUNIT, LGMUH, NGMUH, IFL
      CHARACTER*(*) CFL
      INTEGER LGMUH1, GZGMUH, LZLOC, J, NV, NH, NR
...
C
        ...
        DO J=1,NHITS
          ...
          WRITE(PRUNIT,1104),IQ(IBANK+15),
     &        (IQ(IBANK+L),L=1,5),(Q(IBANK+L),L=6,14)
        END DO       
      END IF
 ...
 1105 FORMAT(' ========================================================
     &====================================='/)
 1103 FORMAT(' IHIT ISET IDET ITRA    NUMB
     &                 HITSUM'/
     &25X,'1    2     1      2      3       4       5      6      7
     &      8      9 ')
