      SUBROUTINE MUON_RZVIN1(VECT,NDIM,RNFILE,RKEY,ICYCLE,CHOPT)
C----------------------------------------------------------------------
C-
C-   Purpose and Methods : EMULATES MUON_RZVIN1
C-
...
C
      RETURN
  998 CALL ERRMSG('MUONLIBRARY','MUON_RZVIN1',
     &  'ERROR OPENING FILE ','W')
      IQUEST(1) = 998
      GO TO 999
  997 CALL ERRMSG('MUONLIBRARY','MUON_RZVIN1',
