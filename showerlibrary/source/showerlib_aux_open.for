      SUBROUTINE SHOWERLIB_AUX_OPEN(IUNIT,FILNAM,SRECL,NEW,READONLY,
     &                           IERR)
C----------------------------------------------------------------------
C-
C-   Purpose and Methods : Open showerlibrary AUXILLIARY FILE
C-
...
C
  ...
  998 FORMAT('OPENED AUXILLIARY FILE',
     &  ' NEW = ',L,' READONLY = ',L,1X,A)
      CALL ERRMSG('SHOWERLIBRARY','SHOWERLIB_AUX_OPEN',
     &  MSG,'W')
  999 RETURN
 9960 CALL ERRMSG('SHOWERLIBRARY','SHOWERLIB_AUX_OPEN',
