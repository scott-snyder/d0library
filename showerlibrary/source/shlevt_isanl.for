...
C
        CALL HBOOK1(21,'ET2,  FOR SET=0-10',100,0.,200.)
        CALL HBOOK1(22,'ET2,  FOR SET=10-20',100,0.,200.)
        CALL HBOOK1(23,'ET2,  FOR SET=20-40',100,0.,200.)
        CALL HBOOK1(24,'ET2,  FOR SET=40-80',100,0.,200.)
        CALL HBOOK1(25,'ET2,  FOR SET=80-160',100,0.,200.)
        CALL HBOOK1(26,'ET2,  FOR SET=160-  ',100,0.,200.)
        CALL HBOOK1(31,'SET,  FOR SET=0-10',100,0.,200.)
        CALL HBOOK1(32,'SET,  FOR SET=10-20',100,0.,200.)
        CALL HBOOK1(33,'SET,  FOR SET=20-40',100,0.,200.)
        CALL HBOOK1(34,'SET,  FOR SET=40-80',100,0.,200.)
        CALL HBOOK1(35,'SET,  FOR SET=80-160',100,0.,200.)
        CALL HBOOK1(36,'SET,  FOR SET=160-  ',100,0.,200.)
C
