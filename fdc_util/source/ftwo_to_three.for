...
C
      IF (FIRST) THEN
        ...
        CALL EZGET_i('USE_FIT_SEGTRK',USE_FIT_SEGTRK,IER)
        CALL EZGET_l('TT_TO_3LAYER',TT_TO_3LAYER,IER)
        CALL EZGET_l('PT_TO_3LAYER',PT_TO_3LAYER,IER)
        CALL EZGET_l('TP_TO_3LAYER',TP_TO_3LAYER,IER)
        CALL EZRSET
        FIRST = .FALSE.
      END IF
C
