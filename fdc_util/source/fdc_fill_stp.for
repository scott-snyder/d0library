...
C
      ...
      CALL EZGET('QUADTYP',QUADTYP,IER)
      IF ( VELOC.GT.0 ) THEN
        UNIT = 0
        DO  HALF =  0, 1
          DO  QUAD=  0, 7
...
C
      CALL EZGETA ('VEL_CELLS',0,0,0,N_VAL,IER)
      CALL EZGETA ('VEL_CELLS',1,N_VAL,7,VEL_HALF(1),IER)
      CALL EZGETA ('VEL_CELLS',2,N_VAL,7,VEL_UNIT(1),IER)
      CALL EZGETA ('VEL_CELLS',3,N_VAL,7,VEL_QUAD(1),IER)
      CALL EZGETA ('VEL_CELLS',4,N_VAL,7,VEL_SECT(1),IER)
...
C
      CALL EZGETA ('MIP_CELLS',0,0,0,N_VAL,IER)
      CALL EZGETA ('MIP_CELLS',1,N_VAL,6,MIP_HALF(1),IER)
      CALL EZGETA ('MIP_CELLS',2,N_VAL,6,MIP_UNIT(1),IER)
      CALL EZGETA ('MIP_CELLS',3,N_VAL,6,MIP_QUAD(1),IER)
      CALL EZGETA ('MIP_CELLS',4,N_VAL,6,MIP_SECT(1),IER)
      CALL EZGETA ('MIP_CELLS',5,N_VAL,6,MIP_WIRE(1),IER)
