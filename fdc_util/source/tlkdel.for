      SUBROUTINE TLKDEL(HALF,QUAD,SECTOR)
C------------------------------------------------------------------
C
C  Purpose : Delete used links (and mirrors) in FDC THETA sector
C
...
C
      INTEGER HALF,QUAD,SECTOR,LLINK,NLINK,ILINK,LOC,I1,I2
...
C
      ...
      DO 200 ILINK=1,NLINK        ! loop over links
        ...
        CALL GTFTSC(HALF,QUAD,SECTOR,'HIT',I1,NEL,NWORDS,QHIT)
        I1=IQHIT(9)
        ...
        CALL GTFTSC(HALF,QUAD,SECTOR,'HIT',I2,NEL,NWORDS,QHIT)
        I2=IQHIT(9)
