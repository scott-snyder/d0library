...
C
        ...
        CALL EZGETA_i ('LUM_ADJ',0,0,0,N_VAL,ERR)
        CALL EZGETA_iarr ('LUM_ADJ',1,N_VAL,WDS_ENTRY,RUN_MIN,ERR)
        CALL EZGETA_iarr ('LUM_ADJ',2,N_VAL,WDS_ENTRY,RUN_MAX,ERR)
        CALL EZGETA ('LUM_ADJ',3,N_VAL,WDS_ENTRY,LUM_LIST(1,0,0)
     &       ,ERR)
