...
C----------------------------------------------------------------------
      ...
      CALL EZGETA ('SHIFT_Z',0,0,0,N_VAL,IER)
      CALL EZGETA ('SHIFT_Z',1,N_VAL,3,SHIFT_HALF(1),IER)
      CALL EZGETA ('SHIFT_Z',2,N_VAL,3,SHIFT_LAYER(1),IER)
      CALL EZGETA ('SHIFT_Z',3,N_VAL,3,Z_SHIFT(1),IER)
      CALL EZGETA ('SHIFT_Z_WIRE',0,0,0,N_VAL_WIRE,IER)
