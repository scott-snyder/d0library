      FUNCTION FGETHITS( HALF,UNIT,QUAD,SECTOR,
...
C-      hits bank, FHIT.
C-      Identical to PFGETHITS (which will soon be obsoleted).
C-
...
C-                                              FHIT bank.
C-   Updated  18-NOV-1993   Robert E. Avery  Creation of FGETHITS from
C-                                              PFGETHITS. 
C-
C----------------------------------------------------------------------
      IMPLICIT NONE
