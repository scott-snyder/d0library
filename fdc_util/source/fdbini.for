...
C
        ...
        CALL EZGET_l('GN_PROC_INI',GN_PROC_INI,IER)
        CALL EZGET_l('PD_PROC_INI',PD_PROC_INI,IER)
        CALL EZGET_l('TM_PROC_INI',TM_PROC_INI,IER)
        CALL EZGET_i('FDBRUN_FORCE',FDBRUN,IER)
