...
C
        CALL EZGET_l('DO_NTUPLE',DO_NTUPLE,IER)
        CALL EZGET_l('DO_CHIS_VECTOR',DO_CHIS_VECTOR,IER)
...
C
     ...
     &      'TOO MANY ADDITIONAL NAMES ','W')
        ...
        ENDIF
C
        CALL EZGET_i('NTUPLE_PRIMARY_ALLOCATION',NTUPL_PRIM,IER)
        CALL EZGET_i('NTUPLE_ID',NTUPL_ID,IER)
