      SUBROUTINE MATRIX_INVERT_TEST2(STRING,MAT,MAT_INV,TOL,NDIM,PROD)
C----------------------------------------------------------------------
C-
...
C-             MAT and MATINV are double precision matrices of DIMENSION NDIM.
...
C----------------------------------------------------------------------
      ...
      CHARACTER *(*) STRING
      INTEGER NDIM
      DOUBLE PRECISION MAT(NDIM,NDIM),MAT_INV(NDIM,NDIM)
      DOUBLE PRECISION PROD(NDIM,NDIM),TEST
      REAL    TOL
...
C
 ...
 1201       FORMAT(' BAD INVERSION:,I,J,TEST ',A,2I12,F15.6)
          ENDIF
 1200 CONTINUE
  999 RETURN
      END
