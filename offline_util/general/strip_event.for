...
C     Strip type...
        CALL EZGET('STRIP_BY_EVENTS',STRIP_EVNT,IER)
        CALL EZGET('STRIP_BY_TRIGGER',STRIP_TRGR,IER)
        CALL EZGET('STRIP_BY_L1L2TRIGGER',STRIP_L1L2TRGR,IER)
C     Events...
        CALL EZGETA('STRIP_EVENTS',0,0,0,NEVENTS,IER)
        CALL EZGET('STRIP_EVENTS',EVENTS,IER)
