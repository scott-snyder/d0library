      SUBROUTINE BKDPZS(LSUP,ND,LBANK)
C----------------------------------------------------------------------
C-
C-   Purpose and Methods : Create CDC zero suppression bank
C-
...
C  Book DPZS bank
C
      CALL MZBOOK(IDVSTP,LBANK,LSUP,-IZDPZS,'DPZS',NL,NS,ND,NIO,0)
C
  999 RETURN
      END
