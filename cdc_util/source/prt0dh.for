...
C
        ...
        DO I=1,NHITS
          IOF = NW*(I-1) + 3
          WRITE (LUN,1010) I,
     &      IQ(LT0DH+IOF).AND.'00000001'X,
     &      (IQ(LT0DH+IOF).AND.'000000FE'X)/2,
     &      (IQ(LT0DH+IOF).AND.'00000700'X)/256,
     &      (IQ(LT0DH+IOF).AND.'0000F800'X)/2048,
     &      (IQ(LT0DH+IOF).AND.'00030000'X)/65536,
     &      (IQ(LT0DH+IOF).AND.'00040000'X)/262144,
     &      (IQ(LT0DH+IOF).AND.'00080000'X)/524288,
     &      (IQ(LT0DH+IOF).AND.'00100000'X)/1048576,
     &      (IQ(LT0DH+IOF).AND.'00200000'X)/2097152,
     &      (IQ(LT0DH+IOF).AND.'00400000'X)/4194304,
     &      IQ(LT0DH+IOF)/8388608,
     &      (IQ(LT0DH+IOF+1).AND.'0000FFFF'X)*0.1,
