...
C                                                                      C
C                    Latest date of change 94.01.10                    C
C                                                                      C
C                              Authors :                               C
C                                                                      C
...
C                                                                      C
C   Copyright 1991,1992,1993,1994 L. Lonnblad & Th. Rognvaldsson       C
C                                                                      C
C                    Please report any errors to:                      C
C              <denni@thep.lu.se> or <THEPDR@SELDC52.BITNET>           C
C                                                                      C
C**********************************************************************C
...
C  Neural Network Package", LU-TP 93-29, subm. to CPC, 1994.           C
C                                                                      C
C**********************************************************************C
...
600   FORMAT(14X,'The Lund Neural Network Program - JETNET version 3.0')
610   FORMAT(14X,'******  Latest date of change: Jan. 10, 1994  ******')
...
C...unformatted read
        ...
        IF(IVERS/10.NE.3) CALL JNERR(13)
        IF(IVERS.EQ.20) THEN
...
C...set sigmoid functions to use
...
C...set beta in layer IL:
          ...
          DO 120 I=MM0(IL)+1,MM0(IL+1)
            DW(I)=DW(I)-2.0*PARJN(14)*PARJN(18)**2*W(I)/
     &            (BETA*(1.0+(W(I)/PARJN(18))**2)**2)
120       CONTINUE

          DO 130 I=MV0(IL)+1,MV0(IL+1)
            DT(I)=DT(I)-2.0*PARJN(14)*PARJN(18)*T(I)/
     &            (BETA*(1.0+(T(I)/PARJN(18))**2)**2)
130       CONTINUE
