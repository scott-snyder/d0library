...
C
     ...
     &  'C',REPLY)
      ...
      CALL GETDIS3(LAYERS,TYPARR,LIMITS,REPONS(1)(1:1),
...
C
     ...
     &  'C',REPLY)
      ...
      CALL GETDIS2(ANODS,TYPARR,LIMITS,REPONS(1)(1:1),
     &REPONS(2)(1:1))
...
C
     ...
     &  'C',REPLY)
      ...
      CALL GETDIS4(UNITS,TYPARR,LIMITS,REPONS(1)(1:1),
     &REPONS(2)(1:1),REPONS(3)(1:1),REPONS(4)(1:1))
...
C
     ...
     &  'C',REPLY) 
      ...
      CALL GETDIS5(HISTOS,TYPARR,LIMITS,REPONS(1)(1:1),
...
C
 ...
 61       FRANCHIES(JJJ+2) = BORNES(JJJ+2)
      CALL GETDIS6(HISLIM,TYPHIS,LIMITS,FRANCHIES(1),
 ...
 62       BORNES(JJJ+2)   = FRANCHIES(JJJ+2) 
        DO 60 KBC = 1,6,3
        CALL EZSETA('HISTO_LIMITS',KBC,KBC,1,BORNES(KBC),IER)
...
C
     ...
     &  'C',REPLY)
      ...
      CALL GETDIS16(SECTORS,TYPARR,LIMITS,REPONS(1)(1:1),
     &REPONS(2)(1:1),REPONS(3)(1:1),REPONS(4)(1:1),REPONS(5)(1:1),
