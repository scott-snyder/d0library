      SUBROUTINE BKTPZS(LSUP,ND,LBANK)
C----------------------------------------------------------------------
C-
C-   Purpose and Methods : Create TRD zero suppression bank
C-
...
C  Book TPZS bank
C
      CALL MZBOOK(IDVSTP,LBANK,LSUP,-IZTPZS,'TPZS',NL,NS,ND,NIO,0)
C
  999 RETURN
      END
