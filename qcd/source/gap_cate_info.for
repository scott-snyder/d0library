...
C
      CALL VZERO_i(NEM_CATD,NEMMAX)
      CALL VZERO_i(NHD_CATD,NHDMAX)
      CALL VZERO_i(NEM_CONE,NEMCMAX)
      CALL VZERO_i(NEM_ACONE,NEMCMAX)
      CALL VZERO_i(NEM_DELTA_R,NEMCMAX)
      CALL VZERO_i(NEM_IETA,NEMIMAX)
      CALL VZERO_i(NEM_IETAG,NEMIMAX)
      CALL VZERO_i(NEM_JET,NEMCMAX)
      CALL VZERO_i(NEM_JALL,NEMCMAX)
      CALL VZERO_i(NEM_EVT,6)
      CALL VZERO_i(NEM_ETABIN,NETAMAX)
      CALL VZERO_i(NEMNEG_ETABIN,NETAMAX)
      CALL VZERO_i(NEMNEG_BINTH2,NMORMAX)
      CALL VZERO_i(NEMNEG_BINTH3,NMORMAX)
      CALL VZERO_i(NEMPOS,NPOSMAX)
      CALL VZERO_i(NEMNEG,NNEGMAX)
      CALL VZERO_i(NHDPOS,NPOSMAX)
      CALL VZERO_i(NHDNEG,NNEGMAX)
      CALL VZERO_i(NEM_BINTH2,NMORMAX)
      CALL VZERO_i(NEM_BINTH3,NMORMAX)
      CALL VZERO_i(NHD_ETABIN,NMORMAX)
      CALL VZERO_i(NHD_BINTH2,NMORMAX)
      CALL VZERO_i(NHD_BINTH3,NMORMAX)
      CALL VZERO_i(NHDNEG_ETABIN,NETAMAX)
      CALL VZERO_i(NHDNEG_BINTH2,NMORMAX)
      CALL VZERO_i(NHDNEG_BINTH3,NMORMAX)
