...
C
     ...
     &      'NO VARIABLE FOUND','F')
      END IF
C
      CALL EZGET_i('NJREQ_ALL', NJREQ_ALL,IER)
      IF ( IER.LT.0) THEN
        CALL ERRMSG('QCD_NTUP_RCP','NJREQ_ALL',
     &      'NO VARIABLE FOUND','W')
      END IF
C
      CALL EZGET_l('ALL_JET', ALL_JET,IER)
      IF ( IER.LT.0) THEN
...
C
C
      CALL EZGET_l('D0MDST', D0MDST,IER)
      IF ( IER.LT.0) THEN
     ...
     &      'NO VARIABLE FOUND','W')
      ...
      END IF
C
      CALL EZGET_l('GAP_JET', GAP_JET,IER)
      IF ( IER.LT.0) THEN
...
C
     ...
     &      'NO VARIABLE FOUND','W')
      ...
      END IF
C
      CALL EZGET_l('DO_USER_BOOK', DO_USER_BOOK,IER)
      IF ( IER.LT.0) THEN
     ...
     &      'NO VARIABLE FOUND','W')
      ...
      END IF
C
      CALL EZGET_l('DO_USER_FILL', DO_USER_FILL,IER)
      IF ( IER.LT.0) THEN
...
C
     ...
     &              'ALL_JET and GAP_JET are false','F')
      END IF
C
      CALL EZGET_l('DO_L1L2', DO_L1L2,IER)
      IF ( IER.LT.0) THEN
...
C
     ...
     &      'NO VARIABLE FOUND','W')
      ...
      END IF
C
      CALL EZGET_l('DO_LUM', DO_LUM,IER)
      IF ( IER.LT.0) THEN
     ...
     &      'NO VARIABLE FOUND--SET TO TRUE','W')
      ...
      END IF
C
      CALL EZGET_l('DO_ELC', DO_ELC,IER)
      IF ( IER.LT.0) THEN
     ...
     &      'NO VARIABLE FOUND','W')
      ...
      END IF
C
      CALL EZGET_l('DO_PHO', DO_PHO,IER)
      IF ( IER.LT.0) THEN
     ...
     &      'NO VARIABLE FOUND','W')
      ...
      END IF
C
      CALL EZGET_l('DO_FULL_JET', DO_FULL_JET,IER)
      IF ( IER.LT.0) THEN
...
C
     ...
     &      'NO VARIABLE FOUND','W')
      ...
      END IF
C
      CALL EZGET_l('MC_DATA', MC_DATA,IER)
      IF ( IER.LT.0) THEN
     ...
     &      'NO VARIABLE FOUND','W')
      ...
      END IF
C
      CALL EZGET_l('UNFILTERED', UNFILTERED,IER)
      IF ( IER.LT.0) THEN
     ...
     &      'ARE YOU SURE YOU WANT TO SKIP FILTERING FOR REAL DATA','W')
      END IF
C
      CALL EZGET_i('PNUTWD', PNUTWD,IER)
      IF ( IER.LT.0) THEN
     ...
     &      'NO VARIABLE FOUND','W')
      ...
      END IF
C
      CALL EZGET_i('MUONWD', MUONWD,IER)
      IF ( IER.LT.0) THEN
     ...
     &      'NO VARIABLE FOUND','W')
      ...
      END IF
C
      CALL EZGET_i('VERTWD', VERTWD,IER)
      IF ( IER.LT.0) THEN
     ...
     &      'NO VARIABLE FOUND','W')
      ...
      END IF
C
      CALL EZGET_i('GLOBWD', GLOBWD,IER)
      IF ( IER.LT.0) THEN
     ...
     &      'NO VARIABLE FOUND','W')
      ...
      END IF
C
      CALL EZGET_i('BADTST', BADTST,IER)
      IF ( IER.LT.0) THEN
     ...
     &      'NO VARIABLE FOUND','W')
      ...
      END IF
C
      CALL EZGET_l('QNT_DATA', QNT_DATA,IER)
      IF ( IER.LT.0) THEN
     ...
     &      'NO VARIABLE FOUND','W')
      ...
      END IF
C
      CALL EZGET_l('ESCALE', ESCALE,IER)
      IF ( IER.LT.0) THEN
     ...
     &      'NO VARIABLE FOUND--set to false','W')
      ...
      END IF
C
      CALL EZGET_i('NCONES', NCONES,IER)
      IF ( IER.LT.0) THEN
     ...
     &      'NO VARIABLE FOUND','W')
      ...
      END IF
C
      CALL EZGET_rarr('RCONES', RCONES,IER)
      IF ( IER.LT.0) THEN
        CALL ERRMSG('QCD_NTUP_RCP','RCONES',
     &      'NO VARIABLE FOUND','W')
      END IF
C
      CALL EZGET_l('NOMERG', NOMERG,IER)
      IF ( IER.LT.0) THEN
     ...
     &      'NO VARIABLE FOUND','W')
      ...
      END IF
C
      CALL EZGET_l('NNEIGH', NNEIGH,IER)
      IF ( IER.LT.0) THEN
     ...
     &      'NO VARIABLE FOUND','W')
      ...
      END IF
C
      CALL EZGET_l('JTCSON', JTCSON,IER)
      IF ( IER.LT.0) THEN
...
C
     ...
     &      'NO VARIABLE FOUND','W')
      ...
      END IF
C
      CALL EZGET_l('EXCLU_NAME', EXCLU_NAME,IER)
      IF ( IER.LT.0) THEN
