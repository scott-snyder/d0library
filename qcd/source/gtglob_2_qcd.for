      SUBROUTINE GTGLOB_2_QCD(TIME29,MRBITS,MAGPOL,L1ANOR,IER)
C----------------------------------------------------------------------
C-
...
C-   Created  25-MAR-1996   A. Brandt rename to GTGLOB_2_QCD
C----------------------------------------------------------------------
      IMPLICIT NONE
...
C
C Hack this out for now 1/5/95 AGB
C
        DO I=1,8
C          L1ANOR(I)=NINT(Q(LGLOB+20+I))
          L1ANOR(I)=0
        ENDDO
      ELSE
        LGLOB = GZGLOB()
