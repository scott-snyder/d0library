...
C
C
      CALL EZGET_l('DO_EM_CATD',DO_EM_CATD,IER)
      IF ( IER.LT.0) THEN
        CALL ERRMSG('GAP_NTUP_RCP','DO_EM_CATD',
     &      'NO VARIABLE FOUND','W')
      END IF
C
      CALL EZGET_l('DO_NEMEVT',DO_NEMEVT,IER)
      IF ( IER.LT.0) THEN
...
C
     ...
     &      'Too many values','W')
      ENDIF
C
      CALL EZGET_l('DO_HD_CATD',DO_HD_CATD,IER)
      IF ( IER.LT.0) THEN
...
C
     ...
     &      'Too many values','W')
      ENDIF
C
      CALL EZGET_l('DO_PACKED_EM',DO_PACKED_EM,IER)
      IF ( IER.LT.0) THEN
        CALL ERRMSG('GAP_NTUP_RCP','DO_PACKED_EM',
     &      'NO VARIABLE FOUND','W')
      END IF
      CALL EZGET_i('NUM_PACKED_EM',NUM_PACKED_EM,IER)
      IF ( IER.LT.0) THEN
     ...
     &      'NUM_PACKED_EM set to MAX of 1000','W')
      ...
      END IF
C
      CALL EZGET_l('DO_PACKED_EMJ',DO_PACKED_EMJ,IER)
      IF ( IER.LT.0) THEN
        CALL ERRMSG('GAP_NTUP_RCP','DO_PACKED_EMJ',
     &      'NO VARIABLE FOUND','W')
      END IF
C
      CALL EZGET_i('NUM_PACKED_EMJ',NUM_PACKED_EMJ,IER)
      IF ( IER.LT.0) THEN
     ...
     &      'NUM_PACKED_EMJ set to MAX of 1000','W')
      ...
      END IF
C
      CALL EZGET_l('DO_PACKED_EMB',DO_PACKED_EMB,IER)
      IF ( IER.LT.0) THEN
        CALL ERRMSG('GAP_NTUP_RCP','DO_PACKED_EMB',
     &      'NO VARIABLE FOUND','W')
      END IF
C
      CALL EZGET_i('NUM_PACKED_EMB',NUM_PACKED_EMB,IER)
      IF ( IER.LT.0) THEN
     ...
     &      'NUM_PACKED_EMB set to MAX of 1000','W')
      ...
      END IF
C
      CALL EZGET_l('DO_EM_CONE',DO_EM_CONE,IER)
      IF ( IER.LT.0) THEN
...
C
     ...
     &      'NO VARIABLE FOUND','W')
      END IF
C
      CALL EZGET_l('DO_EM_DELTA_R',DO_EM_DELTA_R,IER)
      IF ( IER.LT.0) THEN
...
C
     ...
     &      'NO VARIABLE FOUND','W')
      END IF
C
      CALL EZGET_l('DO_EM_IETA_GAP',DO_EM_IETA_GAP,IER)
      IF ( IER.LT.0) THEN
        CALL ERRMSG('GAP_NTUP_RCP','DO_EM_IETA_GAP',
     &      'NO VARIABLE FOUND','W')
      END IF
C
      CALL EZGET_l('DO_EM_IETA_IN_GAP',DO_EM_IETA_IN_GAP,IER)
      IF ( IER.LT.0) THEN
        CALL ERRMSG('GAP_NTUP_RCP','DO_EM_IETA_IN_GAP',
     &      'NO VARIABLE FOUND','W')
      END IF
C
      CALL EZGET_VALUE_TYPE_i('EM_IETA_GAPS',EM_IETA_GAPS,TYPE,
     &                       NEM_IETA_GAPS,IER)
      IF ( IER.LT.0) THEN
     ...
     &      'NO VARIABLE FOUND','W')
      END IF
C
      CALL EZGET_l('DO_REMOVE_JETS_IN_GAP',DO_REMOVE_JETS_IN_GAP,IER)
      IF ( IER.LT.0) THEN
...
C
     ...
     &      'NO VARIABLE FOUND','W')
      END IF
C
      CALL EZGET_l('DO_HOT_KILL',DO_HOT_KILL,IER)
      IF ( IER.LT.0) THEN
        CALL ERRMSG('GAP_NTUP_RCP','DO_HOT_KILL',
     &      'NO VARIABLE FOUND','W')
      END IF
C
      CALL EZGET_l('DO_FIXED_LIST',DO_FIXED_LIST,IER)
      IF ( IER.LT.0) THEN
        CALL ERRMSG('GAP_NTUP_RCP','DO_FIXED_LIST',
     &      'NO VARIABLE FOUND','W')
      END IF
C
      CALL EZGET_l('DO_BY_RUN',DO_BY_RUN,IER)
      IF ( IER.LT.0) THEN
...
C
     ...
     &      'NO VARIABLE FOUND','W')
      END IF
C
      CALL EZGET_i('LOW_STATS_CUT',LOCUT,IER)
      IF ( IER.LT.0) THEN
        CALL ERRMSG('GAP_NTUP_RCP','LOW_STATS_CUT',
     &      'NO VARIABLE FOUND','W')
      END IF
C
      CALL EZGET_i('HIGH_STATS_CUT',HICUT,IER)
      IF ( IER.LT.0) THEN
...
C
     ...
     &      'NO VARIABLE FOUND','W')
      END IF
C
      CALL EZGET_l('DO_WRITE_RUN_EVT',DO_WRITE_RUN_EVT,IER)
      IF ( IER.LT.0) THEN
        CALL ERRMSG('GAP_NTUP_RCP','DO_WRITE_RUN_EVT',
     &      'NO VARIABLE FOUND','W')
      END IF
C
      CALL EZGET_l('DO_TRACK',DO_TRACK,IER)
      IF ( IER.LT.0) THEN
        CALL ERRMSG('GAP_NTUP_RCP','DO_TRACK',
     &      'NO VARIABLE FOUND','W')
      END IF
C
      CALL EZGET_l('DO_L0HITS',DO_L0HITS,IER)
      IF ( IER.LT.0) THEN
        DO_L0HITS=.FALSE.
     ...
     &      'NO VARIABLE FOUND','W')
      END IF
C
      CALL EZGET_l('DO_EM_ETABIN',DO_EM_ETABIN,IER)
      IF ( IER.LT.0) THEN
        DO_EM_ETABIN=.FALSE.
     ...
     &      'NO VARIABLE FOUND','W')
      END IF
C
      CALL EZGET_i('MBIETA',MBIETA,IER)
      IF ( IER.LT.0) THEN
        MBIETA=20
...
C
     ...
     &      'Too many HD_NEG_THRESHOLDS--set to 5','W')
      ...
      END IF
C
      CALL EZGET_l('DO_PACKED_NEG',DO_PACKED_NEG,IER)
      IF ( IER.LT.0) THEN
        CALL ERRMSG('GAP_NTUP_RCP','DO_PACKED_NEG',
     &      'NO VARIABLE FOUND--USED FOR CATE','W')
      END IF
C
      CALL EZGET_i('NUM_PACKED_NEG',NUM_PACKED_NEG,IER)
      IF ( IER.LT.0) THEN
     ...
     &      'NUM_PACKED_NEG set to MAX of 200','W')
      ...
      END IF
C
      CALL EZGET_l('DO_EM_MORBIN',DO_EM_MORBIN,IER)
      IF ( IER.LT.0) THEN
     ...
     &      'NOT ENOUGH MORE BINS CHECK POS THRESH ','W')
      ...
      END IF
C
      CALL EZGET_l('DO_EMNEG_ETABIN',DO_EMNEG_ETABIN,IER)
      IF ( IER.LT.0) THEN
     ...
     &      'NO VARIABLE FOUND--USED FOR CATE','W')
      END IF
C
      CALL EZGET_l('DO_EMNEG_MORBIN',DO_EMNEG_MORBIN,IER)
      IF ( IER.LT.0) THEN
     ...
     &      'NOT ENOUGH MORE BINS CHECK POS THRESH ','W')
      ...
      END IF
C
      CALL EZGET_l('DO_HD_ETABIN',DO_HD_ETABIN,IER)
      IF ( IER.LT.0) THEN
     ...
     &      'NO VARIABLE FOUND--USED FOR CATE','W')
      ...
      END IF
C
      CALL EZGET_l('DO_HD_MORBIN',DO_HD_MORBIN,IER)
      IF ( IER.LT.0) THEN
     ...
     &      'NOT ENOUGH MORE BINS CHECK POS THRESH ','W')
      ...
      END IF
C
      CALL EZGET_l('DO_HDNEG_ETABIN',DO_HDNEG_ETABIN,IER)
      IF ( IER.LT.0) THEN
     ...
     &      'NO VARIABLE FOUND--USED FOR CATE','W')
      END IF
C
      CALL EZGET_l('DO_HDNEG_MORBIN',DO_HDNEG_MORBIN,IER)
      IF ( IER.LT.0) THEN
     ...
     &      'NOT ENOUGH MORE BINS CHECK POS THRESH ','W')
      ...
      END IF
C
      CALL EZGET_l('DO_ENERGY_SLICES',DO_ENERGY_SLICES,IER)
      IF ( IER.LT.0) THEN
     ...
     &      'NO VARIABLE FOUND--USED FOR CATE','W')
      END IF
C
      CALL EZGET_l('DO_SAMULT',DO_SAMULT,IER)
      IF ( IER.LT.0) THEN
     ...
     &      'NO VARIABLE FOUND','W')
      ...
      END IF
C
      CALL EZGET_l('DO_FDCTRK',DO_FDCTRK,IER)
      IF ( IER.LT.0) THEN
     ...
     &      'NO VARIABLE FOUND','W')
      ...
      END IF
C
      CALL EZGET_l('DO_FDCSEG',DO_FDCSEG,IER)
      IF ( IER.LT.0) THEN
