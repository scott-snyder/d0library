...
C  Open OTC tables.
	...
	DO I = 1, 8
	   IF(I.LT.6)THEN
C&IF LINUX
C&             OPEN(LUN_CR21(I),FILE=CR21TAB(I),
C&     &         FORM='UNFORMATTED',ACCESS='DIRECT',STATUS='OLD',RECL=1)
C&ELSE
...
C&ENDIF
	   ...
	   IF(I.LT.7)THEN
C&IF LINUX
C&             OPEN(LUN_CR31(I),FILE=CR31TAB(I),
C&     &         FORM='UNFORMATTED',ACCESS='DIRECT',STATUS='OLD',RECL=1)
C&             OPEN(LUN_CR41(I),FILE=CR41TAB(I),
C&     &         FORM='UNFORMATTED',ACCESS='DIRECT',STATUS='OLD',RECL=1)
C&ELSE
...
C&ENDIF
	   ENDIF
C&IF LINUX
C&           OPEN(LUN_CR51(I),FILE=CR51TAB(I),
C&     &       FORM='UNFORMATTED',ACCESS='DIRECT',STATUS='OLD',RECL=1)
C&           OPEN(LUN_CR61(I),FILE=CR61TAB(I),
C&     &       FORM='UNFORMATTED',ACCESS='DIRECT',STATUS='OLD',RECL=1)
C&ELSE
...
C&IF LINUX
C&	OPEN(LUN_SCN,FILE=CHSEL_NTAB,
C&     &         FORM='UNFORMATTED',ACCESS='DIRECT',STATUS='OLD',RECL=1)
C&	OPEN(LUN_SCS,FILE=CHSEL_STAB,
C&     &         FORM='UNFORMATTED',ACCESS='DIRECT',STATUS='OLD',RECL=1)
C&
C&	OPEN(LUN_CONSEC1,FILE=CONSEC_TAB1,
C&     &         FORM='UNFORMATTED',ACCESS='DIRECT',STATUS='OLD',RECL=1)
C&	OPEN(LUN_CONSEC2,FILE=CONSEC_TAB2,
C&     &         FORM='UNFORMATTED',ACCESS='DIRECT',STATUS='OLD',RECL=1)
C&ELSE
