...
C----------------------------------------------------------------------
C-
C-   Purpose and Methods : Tests CCT trigger for End bottom quadrants.
C-
...
C<<
        ...
        IF(IER.NE.0) THEN
          ...
          CALL ERRMSG(' EZPICK ERR','MU_CCT_EF_BOT',STRING,'F')
          GOTO 999
        ENDIF
C
        ...
        IF(IER.NE.0) THEN
          CALL EZGET_ERROR_TEXT(IER,STRING)
          CALL ERRMSG(' WAM_CCT_VERS','MU_CCT_EF_BOT',STRING,'F')
          GOTO 999
        ENDIF
C
        CALL EZRSET()
...
C.. Calculate first stage pal logic
     ...
     &        + B(15)*C(15) + B(15)*C(16)
        ...
        BC(9) = B(18)*C(8)  + B(18)*C(18) + B(18)*C(19)
     &        + B(19)*C(18) + B(19)*C(19) + B(19)*C(20)
        BC(10) = B(18)*C(8)  + B(18)*C(18) + B(18)*C(19)
     &         + B(19)*C(19) + B(19)*C(20)
        BC(11) = B(18)*C(8)  + B(18)*C(18) + B(18)*C(19)
     &         + B(19)*C(18) + B(19)*C(19) + B(19)*C(20)
        BC(12) = B(19)*C(19) + B(19)*C(20) + B(20)*C(19) + B(20)*C(20)
      ENDIF
     ...
     &        + B(15)*C(15) + B(15)*C(16) + B(16)*C(16)
        BC(7) = B(14)*C(13) + B(14)*C(14) + B(14)*C(15)
     &        + B(15)*C(14) + B(15)*C(15) + B(15)*C(16)
     &        + B(16)*C(16)
        BC(8) = B(15)*C(15) + B(15)*C(16)
     &        + B(16)*C(15) + B(16)*C(16)
        BC(9) = B(18)*C(18) + B(18)*C(19) + B(18)*C(20)
     &        + B(19)*C(18) + B(19)*C(19) + B(19)*C(20)
        BC(10) = B(18)*C(18) + B(18)*C(19) + B(18)*C(20)
        BC(11) = B(18)*C(18) + B(18)*C(19) + B(18)*C(20)
     &         + B(19)*C(18) + B(19)*C(19) + B(19)*C(20)
        BC(12) = B(20)*C(19) + B(20)*C(20)
      ENDIF
...
C.. compute different roads independently for monitoring
      ...
      IROAD(16)  = A(6) *B(16)*C(16)

      IROAD(20)  = A(7) *B(14)*C(13)
      IROAD(21)  = A(7) *B(14)*C(14)
      IROAD(22)  = A(7) *B(14)*C(15)
      IROAD(23)  = A(7) *B(15)*C(14)
      IROAD(24)  = A(7) *B(15)*C(15)
      IROAD(25)  = A(7) *B(15)*C(16)
      IROAD(26)  = A(7) *B(16)*C(16)

      IROAD(30)  = A(8) *B(15)*C(15)
      IROAD(31)  = A(8) *B(15)*C(16)
      IROAD(32)  = A(8) *B(16)*C(15)
      IROAD(33)  = A(8) *B(16)*C(16)

      IROAD(37)  = A(9) *B(18)*C(18)
      IROAD(38)  = A(9) *B(18)*C(19)
      IROAD(39)  = A(9) *B(18)*C(20)
      IROAD(40)  = A(9) *B(19)*C(18)
      IROAD(41)  = A(9) *B(19)*C(19)
      IROAD(42)  = A(9) *B(19)*C(20)

      IROAD(46)  = A(10)*B(18)*C(18)
      IROAD(47)  = A(10)*B(18)*C(19)
      IROAD(48)  = A(10)*B(18)*C(20)

      IROAD(52) = A(11)*B(18)*C(18)
      IROAD(53) = A(11)*B(18)*C(19)
      IROAD(54) = A(11)*B(18)*C(20)
      IROAD(55) = A(11)*B(19)*C(18)
      IROAD(56) = A(11)*B(19)*C(19)
      IROAD(57) = A(11)*B(19)*C(20)
...
C      CALL WAMUS_ROADS(2200,A,B,C,JBITS)
