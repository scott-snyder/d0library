...
C   Get parameters from WZ.RCP
        NSTRIP_Z = 0
        CALL EZPICK('WZ_RCP')
        CALL EZGET_l('DO_Z_CUTS', DO_Z_CUTS, IER)
        CALL EZGET_l('WRITE_Z_EVENT', WRITE_Z_EVENT, IER)
        ...
        CALL EZGET_l('DO_MU_SIGN', DO_MU_SIGN, IER)
        CALL EZGET('Z_ISOMAX',ISOMAX , IER)
        CALL EZGET('Z_ISOMIN',ISOMIN , IER)
        CALL EZGET('Z_IMPCXY',IMPCXY , IER)
        CALL EZGET_l('DO_TIGHT_Z_CUT', DO_TIGHT_Z_CUT, IER)
        CALL EZGET_l('DO_LOOSE_Z_CUT', DO_LOOSE_Z_CUT, IER)
        CALL EZGET_l('OCTANT_CUT', OCTANT_CUT, IER)
        CALL EZGET_i('IFW4CUT', IFW4CUT, IER)
        CALL EZGET_l('NO_OPP_TRACK', NO_OPP_TRACK, IER)
        CALL EZGET('DELTA_PHI', DELTA_PHI, IER)
        CALL EZGET('DELTA_THE', DELTA_THE, IER)
        CALL EZGET_l('CHECK_MAGNET', CHECK_MAGNET, IER)
        CALL EZGET_l('Z_DO_GFIT_CUTS',DO_GFIT_CUTS , IER)
        CALL EZGET('Z_CHISQ_GFIT',CHISQ_GFIT , IER)
        CALL EZGET_l('DO_DPHI_CUT',DO_DPHI_CUT, IER)
        CALL EZGET('DPHICUT', DPHICUT, IER)
        CALL EZGET_l('REJECT_Z_EVENT', REJECT_Z_EVENT, IER)
