...
C-   Updated  18-JUL-1991   Lupe Howell  Update a misspel 
C-   Updated  18-NOV-1991   JFG  added the cathodes again 
...
C
      ...
      CHARACTER*(*) MENNAM
      PARAMETER( MENNAM  = 'SELECT_WIRE_HITS' )
