       SUBROUTINE P6LEGO(NX,XMIN,XMAX,NY,YMIN,YMAX,ECUT,ZMAX,TITLE,
...
C      Mar 07, 1994 - Nobuaki Oshima
C            ( Color scheme for the ISATOP Package )
C
C=====================================================================
      IMPLICIT NONE
C=====================================================================
...
C    ==================
     ...
     X     WX,WY,WZ,PLZMAX,ZMED,ZDIV
      ...
      INTEGER KCOL, COL, INTE, FIL, STYL
      CHARACTER*24 IMESS1
      CHARACTER*3  CC
C    Data Statements:
C    ================
...
C  DEFINE BAR
      ...
      IF (TZMAX.GT.0) THEN
        IF(IARRAY(J,IETA).GT.0.AND.IARRAY(J,IETA).LT.17)THEN
          KCOL=IARRAY(J,IETA)
        ELSE
          KCOL=17  ! Foreground 
        ENDIF
