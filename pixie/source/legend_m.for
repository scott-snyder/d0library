      SUBROUTINE LEGEND_M(COLOR,LABEL, CODE)
C----------------------------------------------------------------------
C-
C-   Purpose and Methods : Prints a vertical line with "M" and 
C-              a label explaining its meaning.
C-              
C-
C-   Inputs  : COLOR - the color of the line
...
C-
C-   Created   15-JAN-1993 S. Hagopian
...
C DRAW 'M'
        ...
        XDEL=(X1-X0)/2.
        YDEL=(Y0-Y1)/2.
        CALL J3DRAW(X0+XDEL,Y0+YDEL,0.)
        CALL J3DRAW(X0+XDEL,Y0,0.)
        CALL J3MOVE(X0,Y0,0.)
        CALL J3DRAW(X0-XDEL,Y0+YDEL,0.)
        CALL J3DRAW(X0-XDEL,Y0,0.)
C PRINT LABEL
