...
C-
     ...
     &    'W')
        GOTO 999
      ENDIF
      CALL PUGET_i('ZTRAKS DRAW HITS  ',DRAW_HITS)
      CALL PUGET_l('ZTRAKS DRAW ZTRKS ',DRAW_ZTRKS)
      CALL PUGET_l('ZTRAKS DRAW DTRKS ',DRAW_DTRKS)
      CALL PUGET_l('ZTRAKS DRAW FTRKS ',DRAW_FTRKS)
      CALL PUGET_l('ZTRAKS DRAW VTRKS ',DRAW_VTRKS)
      CALL EZRSET
C-
C--- Draw Modules
C-
