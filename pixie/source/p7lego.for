      SUBROUTINE P7LEGO(NX,XMIN,XMAX,NY,YMIN,YMAX,ECUT,ZMAX,TITLE,
...
C      Mar 23, 1995 - Nobuaki Oshima, Modified to handle 4 Arrays for -E.
C
C=====================================================================
      IMPLICIT NONE
C=====================================================================
...
C    ==================
     ...
     X     UMIN,UMAX,VMIN,VMAX,
     X     XSIZE,YSIZE,PLZMAX,ZMED
      INTEGER I,J,IETA,IPHI
      INTEGER ICOLOR(4)
      CHARACTER*38 IMESS1
