...
C
      ...
      CALL EZGET_l('WATCH_CRAZIES',SEARCH_CRAZY,IER)
      CALL EZGET('LOW_CRAZY_LIMIT',LOW_CRAZY,IER)
      CALL EZGET('HIGH_CRAZY_LIMIT',HIGH_CRAZY,IER)
      CALL EZGET_i('HIST_ID_OFFSET',IOFF1,IER)
      CALL EZGET_i('WATCH_ID_OFFSET',IOFF2,IER)
      CALL EZGET_iarr('PHYSICS_WATCH',PHYSICS,IER)
      CALL EZGET_iarr('ELECTRONICS_WATCH',ELECTRONICS,IER)
      CALL EZRSET
C
