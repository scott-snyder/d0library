...
C
      ...
      INTEGER TRANS_MATRIX16(9), PHILIM, ETALIM
...
C
      ...
      IF (FIRST) THEN
        ...
        ENDIF
        CALL EZGET('TRANS_MATRIX16',TRANS_MATRIX16,IER)
        CALL EZRSET
C
...
C
     ...
     &      COOR_PTR = 1
        ...
        CALL EZGET('REWORK_CLUSTER_CENTROID',REWORK,IER)
        CALL EZGET('USE_LOG_REWORK',USE_LOG_REWORK,IER)
