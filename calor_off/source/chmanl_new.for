...
C
        ...
        CALL EZGET_rarr('ZETA_CUT',ZETA_CUT,IER)
        CALL EZGET_rarr('EIGEN_VALUE_MAX_MAP',EIGEN_VALUE_MAX_MAP,IER)
        CALL EZGET('MAXIMUM_VISIBLE_ET',ET_MAX,IER)
        CALL EZGET_i('HMATRIX_DUMP_EVENTS',HMATRIX_DUMP_EVENTS,IER)
        CALL EZGET_l('ADD_CRYOSTAT_ENERGY',ADD_CRYO,IER)
        CALL EZGET_l('ADD_CRACK_ENERGY',ADD_CRACK,IER)
        ...
        CALL EZGET_l('DO_HMATRIX_NTUPLE',DO_NTUPLE,IER)
        CALL EZRSET
      ENDIF
C
...
C
      ...
      ENDIF
C
      CALL EZGET_l('USE_DEAD_ENERGY',USE_DEAD_ENERGY,IER)
      CALL EZGET_l('USE_POSITION_INFO',USE_POSITION_INFO,IER)
      CALL EZGET_l('USE_ENERGY_RATIO',USE_ENERGY_RATIO,IER)
