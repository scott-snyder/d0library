...
C
      IF(FIRST)THEN                     ! LOCAL INIT
        ...
        CALL EZGET_l('ECEM_DO_DELTA',ECEM_DO_DELTA,IER)
        CALL EZGET_l('ECEM_DO_CRACK',ECEM_DO_CRACK,IER)
        CALL EZGET_l('ECEM_DO_BOLT',ECEM_DO_BOLT,IER)
        CALL EZGET_l('ECEM_DO_OUT_RAD',ECEM_DO_OUT_RAD,IER)
        CALL EZGET_l('ECEM_DO_NEW_CELL_E',ECEM_DO_NEW_CELL_E,IER)
        CALL EZGET_l('ECEM_MIN_CORR',ECEM_MIN_CORR,IER)
        CALL EZGET_i('IETA_MIN',IETA_MIN, IER)
        CALL EZGET('THRESH_DE',THRESH_DE, IER)
        CALL EZGET_l('ECEMCR_DEBUG',ECEMCR_DEBUG,IER)
        CALL EZGET_l('USE_ISA_TRK',USE_ISA_TRK,IER)
        CALL EZGET_l('USE_PWC_TRK',USE_PWC_TRK,IER)
        CALL EZRSET
C
