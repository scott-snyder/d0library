...
C
      IF(FIRST)THEN                     ! LOCAL INIT
        ...
        CALL EZGET_l('HMATRIX_READ',HMREAD,IER)
        CALL EZGET_l('HMATRIX_PRED',HMPRED,IER)
        CALL EZGET_l('HMATRIX_ITER',HMITER,IER)
        CALL EZGET('PROB_LONGITUDINAL_CUT',PROB_LONGITUDINAL_CUT,IER)
        CALL EZGET('PROB_FULL_CUT',PROB_FULL_CUT,IER)
        CALL EZGET_l('PREDICT_LONGITUDINAL',PREDICT_LONGITUDINAL,IER)
        CALL EZGET_l('PREDICT_FULL',PREDICT_FULL,IER)
        CALL EZGET_l('LEVEL_TWO',LEVEL_TWO,IER)
        CALL EZGET_i('MAXIMUM_ETA',ETAMAX,IER)
