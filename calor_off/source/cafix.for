...
C
     ...
     &      STATUS)
          IF ( STATUS .EQ. 0 ) CALL EZGET_l('DO_EM_CORRECTION',
     &      DO_EM_CORRECTION, STATUS )
          IF ( STATUS .EQ. 0 ) CALL EZGET_l('DO_JET_CORRECTION',
     &      DO_JET_CORRECTION, STATUS )
          IF ( STATUS .EQ. 0 ) CALL EZGET_l('DO_ZSP_CORRECTION',
     &      DO_ZSP_CORRECTION, STATUS )
          IF ( STATUS .EQ. 0 ) CALL EZGET_l('DO_UND_CORRECTION',
     &      DO_UND_CORRECTION, STATUS )
          IF ( STATUS .EQ. 0 ) CALL EZGET_l('DO_CONE_CORRECTION',
     &      DO_CONE_CORRECTION, STATUS )
          IF ( STATUS .EQ. 0 ) CALL EZGET('ISYS',
     &      ISYS, STATUS )
          IF ( STATUS .EQ. 0 ) CALL EZGET_l('DO_MET_CORRECTION',
