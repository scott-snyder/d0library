...
OPT = -O2
ARFLAGS = crsl
SCRATCH = $(d0library)/tmp/d0librar/userlib/18406/d0dbl3
FLAVOR = SIUNIX
CC = cc
LEX = lex
F77 = f77
...
opt :\
  d0dbl3.a
d0dbl3.a : $(d0root)/test/dbl3/d0dbl3.a
	@ echo d0dbl3.a is up to date
$(d0root)/test/dbl3/d0dbl3.a:: $(SCRATCH)/nothing.nl
$(d0root)/test/dbl3/d0dbl3.a::\
  $(d0root)/test/dbl3/d0dbl3.a(xclblnk.o)\
  $(d0root)/test/dbl3/d0dbl3.a(xcondbl.o)\
  $(d0root)/test/dbl3/d0dbl3.a(xdbclb_detseq.o)\
  $(d0root)/test/dbl3/d0dbl3.a(xdbclb_end.o)\
  $(d0root)/test/dbl3/d0dbl3.a(xdbclb_finish.o)\
  $(d0root)/test/dbl3/d0dbl3.a(xdbclb_init.o)\
  $(d0root)/test/dbl3/d0dbl3.a(xdbclblize682.o)\
  $(d0root)/test/dbl3/d0dbl3.a(xdbclb_path.o)\
  $(d0root)/test/dbl3/d0dbl3.a(xdbclbinfo560.o)\
  $(d0root)/test/dbl3/d0dbl3.a(xdbclb_seqdet.o)\
  $(d0root)/test/dbl3/d0dbl3.a(xerrdb.o)\
  $(d0root)/test/dbl3/d0dbl3.a(xinzdbl.o)\
  $(d0root)/test/dbl3/d0dbl3.a(xdbclbline964.o)\
  $(d0root)/test/dbl3/d0dbl3.a(xdbo_ggers700.o)\
  $(d0root)/test/dbl3/d0dbl3.a(xgt_dbfile.o)\
  $(d0root)/test/dbl3/d0dbl3.a(xd3u_end.o)\
  $(d0root)/test/dbl3/d0dbl3.a(xd3u_fetch.o)\
  $(d0root)/test/dbl3/d0dbl3.a(xd3u_fetcm.o)\
  $(d0root)/test/dbl3/d0dbl3.a(xd3u_ini.o)\
  $(d0root)/test/dbl3/d0dbl3.a(xd3u_insrt.o)\
  $(d0root)/test/dbl3/d0dbl3.a(xd3u_kychk.o)\
  $(d0root)/test/dbl3/d0dbl3.a(xd3u_kycls.o)\
  $(d0root)/test/dbl3/d0dbl3.a(xd3u_set.o)\
  $(d0root)/test/dbl3/d0dbl3.a(xd3u_start.o)\
  $(d0root)/test/dbl3/d0dbl3.a(xd3unit.o)\
  $(d0root)/test/dbl3/d0dbl3.a(xd3utop.o)\
  $(d0root)/test/dbl3/d0dbl3.a(xd3uxh.o)\
  $(d0root)/test/dbl3/d0dbl3.a(xdbmctoh.o)\
  $(d0root)/test/dbl3/d0dbl3.a(xdbmu_enddm.o)\
  $(d0root)/test/dbl3/d0dbl3.a(xdbmu_endhv.o)\
  $(d0root)/test/dbl3/d0dbl3.a(xdbmu_file.o)\
  $(d0root)/test/dbl3/d0dbl3.a(xdbmu_finf.o)\
  $(d0root)/test/dbl3/d0dbl3.a(xdbmu_fno.o)\
  $(d0root)/test/dbl3/d0dbl3.a(xdbmu_getc.o)\
  $(d0root)/test/dbl3/d0dbl3.a(xdbmu_getdm.o)\
  $(d0root)/test/dbl3/d0dbl3.a(xdbmu_gethv.o)\
  $(d0root)/test/dbl3/d0dbl3.a(xdbmu_gtfile.o)\
  $(d0root)/test/dbl3/d0dbl3.a(xdbmu_unpdm.o)\
  $(d0root)/test/dbl3/d0dbl3.a(xdbmu_unphv.o)\
  $(d0root)/test/dbl3/d0dbl3.a(xdbuky.o)\
  $(d0root)/test/dbl3/d0dbl3.a(xdbume.o)\
  $(d0root)/test/dbl3/d0dbl3.a(xdukeyd.o)\
  $(d0root)/test/dbl3/d0dbl3.a(xmsgo.o)\
  $(d0root)/test/dbl3/d0dbl3.a(xd0dblinct238.o)\
  $(d0root)/test/dbl3/d0dbl3.a(xd0dblpkts258.o)\
  $(d0root)/test/dbl3/d0dbl3.a(xd0dblupts268.o)\
  $(d0root)/test/dbl3/d0dbl3.a(xd3upt.o)
	ar $(ARFLAGS) $(d0root)/test/dbl3/d0dbl3.a `ls $(SCRATCH)/a1/*.o 2> /dev/null`
	ar $(ARFLAGS) $(d0root)/test/dbl3/d0dbl3.a `ls $(SCRATCH)/a2/*.o 2> /dev/null`
	ar $(ARFLAGS) $(d0root)/test/dbl3/d0dbl3.a `ls $(SCRATCH)/a3/*.o 2> /dev/null`
	rmdirp $(SCRATCH)
$(SCRATCH)/nothing.nl:
	rmdirp $(SCRATCH)
	mkdirp $(SCRATCH)/a1
...
$(d0root)/test/dbl3/d0dbl3.a(xclblnk.o):\
  ...
  $(d0library)/inc/lkcalib.inc
	(cd $(d0root);\
	$(F77) $(F77FLAGS) $(OPT) $(d0library)/dbl3/calib/clblnk.f ;\
...
$(d0root)/test/dbl3/d0dbl3.a(xcondbl.o):\
  ...
  $(d0library)/links/izstpn.link
	(cd $(d0root);\
	$(F77) $(F77FLAGS) $(OPT) $(d0library)/dbl3/calib/condbl.f ;\
...
$(d0root)/test/dbl3/d0dbl3.a(xdbclb_detseq.o):\
  ...
  $(d0library)/inc/dbstp.inc
	(cd $(d0root);\
	$(F77) $(F77FLAGS) $(OPT) $(d0library)/dbl3/calib/dbclb_detseq.f ;\
...
$(d0root)/test/dbl3/d0dbl3.a(xdbclb_end.o):\
  ...
  $(d0library)/inc/quest.inc
	(cd $(d0root);\
	$(F77) $(F77FLAGS) $(OPT) $(d0library)/dbl3/calib/dbclb_end.f ;\
...
$(d0root)/test/dbl3/d0dbl3.a(xdbclb_finish.o):\
  ...
  $(d0library)/inc/quest.inc
	(cd $(d0root);\
	$(F77) $(F77FLAGS) $(OPT) $(d0library)/dbl3/calib/dbclb_finish.f ;\
...
$(d0root)/test/dbl3/d0dbl3.a(xdbclb_init.o):\
  ...
  $(d0library)/inc/db_srvr_units.inc
	(cd $(d0root);\
	$(F77) $(F77FLAGS) $(OPT) $(d0library)/dbl3/calib/dbclb_init.f ;\
...
$(d0root)/test/dbl3/d0dbl3.a(xdbclblize682.o):\
  ...
  $(d0library)/inc/dbstp.inc
	(cd $(d0root);\
	$(F77) $(F77FLAGS) $(OPT) $(d0library)/dbl3/calib/dbclb_initialize.f ;\
	mv dbclb_initialize.o $(SCRATCH)/a1/dbclblize682.o ;\
	)
$(d0root)/test/dbl3/d0dbl3.a(xdbclb_path.o):\
  $(d0library)/dbl3/calib/dbclb_path.f
	(cd $(d0root);\
	$(F77) $(F77FLAGS) $(OPT) $(d0library)/dbl3/calib/dbclb_path.f ;\
...
$(d0root)/test/dbl3/d0dbl3.a(xdbclbinfo560.o):\
  ...
  $(d0library)/links/izssam.link
	(cd $(d0root);\
	$(F77) $(F77FLAGS) $(OPT) $(d0library)/dbl3/calib/dbclb_path_info.f ;\
	mv dbclb_path_info.o $(SCRATCH)/a1/dbclbinfo560.o ;\
	)
$(d0root)/test/dbl3/d0dbl3.a(xdbclb_seqdet.o):\
  $(d0library)/dbl3/calib/dbclb_seqdet.f
	(cd $(d0root);\
	$(F77) $(F77FLAGS) $(OPT) $(d0library)/dbl3/calib/dbclb_seqdet.f ;\
...
$(d0root)/test/dbl3/d0dbl3.a(xerrdb.o):\
  ...
  $(d0library)/inc/quest.inc
	(cd $(d0root);\
	$(F77) $(F77FLAGS) $(OPT) $(d0library)/dbl3/calib/errdb.f ;\
...
$(d0root)/test/dbl3/d0dbl3.a(xinzdbl.o):\
  ...
  $(d0library)/inc/zebdbl.inc
	(cd $(d0root);\
	$(F77) $(F77FLAGS) $(OPT) $(d0library)/dbl3/calib/inzdbl.f ;\
...
$(d0root)/test/dbl3/d0dbl3.a(xdbclbline964.o):\
  ...
  $(d0library)/links/izstpc.link
	(cd $(d0root);\
	$(F77) $(F77FLAGS) $(OPT) $(d0library)/dbl3/dboffline/dbclb_fetch_offline.f ;\
	mv dbclb_fetch_offline.o $(SCRATCH)/a1/dbclbline964.o ;\
	)
$(d0root)/test/dbl3/d0dbl3.a(xdbo_ggers700.o):\
  $(d0library)/dbl3/dboffline/dbo_get_triggers.f
	(cd $(d0root);\
	$(F77) $(F77FLAGS) $(OPT) $(d0library)/dbl3/dboffline/dbo_get_triggers.f ;\
	mv dbo_get_triggers.o $(SCRATCH)/a1/dbo_ggers700.o ;\
	)
$(d0root)/test/dbl3/d0dbl3.a(xgt_dbfile.o):\
  $(d0library)/dbl3/dboffline/gt_dbfile.f
	(cd $(d0root);\
	$(F77) $(F77FLAGS) $(OPT) $(d0library)/dbl3/dboffline/gt_dbfile.f ;\
...
$(d0root)/test/dbl3/d0dbl3.a(xd3u_end.o):\
  ...
  $(d0library)/inc/quest.inc
	(cd $(d0root);\
	$(F77) $(F77FLAGS) $(OPT) $(d0library)/dbl3/general/d3u_end.f ;\
...
$(d0root)/test/dbl3/d0dbl3.a(xd3u_fetch.o):\
  ...
  $(d0library)/inc/quest.inc
	(cd $(d0root);\
	$(F77) $(F77FLAGS) $(OPT) $(d0library)/dbl3/general/d3u_fetch.f ;\
...
$(d0root)/test/dbl3/d0dbl3.a(xd3u_fetcm.o):\
  ...
  $(d0library)/inc/zebstp.inc
	(cd $(d0root);\
	$(F77) $(F77FLAGS) $(OPT) $(d0library)/dbl3/general/d3u_fetcm.f ;\
...
$(d0root)/test/dbl3/d0dbl3.a(xd3u_ini.o):\
  ...
  $(d0library)/inc/d3u.inc
	(cd $(d0root);\
	$(F77) $(F77FLAGS) $(OPT) $(d0library)/dbl3/general/d3u_ini.f ;\
...
$(d0root)/test/dbl3/d0dbl3.a(xd3u_insrt.o):\
  ...
  $(d0library)/inc/quest.inc
	(cd $(d0root);\
	$(F77) $(F77FLAGS) $(OPT) $(d0library)/dbl3/general/d3u_insrt.f ;\
...
$(d0root)/test/dbl3/d0dbl3.a(xd3u_kychk.o):\
  ...
  $(d0library)/inc/quest.inc
	(cd $(d0root);\
	$(F77) $(F77FLAGS) $(OPT) $(d0library)/dbl3/general/d3u_kychk.f ;\
...
$(d0root)/test/dbl3/d0dbl3.a(xd3u_kycls.o):\
  ...
  $(d0library)/inc/quest.inc
	(cd $(d0root);\
	$(F77) $(F77FLAGS) $(OPT) $(d0library)/dbl3/general/d3u_kycls.f ;\
...
$(d0root)/test/dbl3/d0dbl3.a(xd3u_set.o):\
  ...
  $(d0library)/inc/d3u.inc
	(cd $(d0root);\
	$(F77) $(F77FLAGS) $(OPT) $(d0library)/dbl3/general/d3u_set.f ;\
...
$(d0root)/test/dbl3/d0dbl3.a(xd3u_start.o):\
  ...
  $(d0library)/inc/quest.inc
	(cd $(d0root);\
	$(F77) $(F77FLAGS) $(OPT) $(d0library)/dbl3/general/d3u_start.f ;\
...
$(d0root)/test/dbl3/d0dbl3.a(xd3unit.o):\
  ...
  $(d0library)/inc/d3u.inc
	(cd $(d0root);\
	$(F77) $(F77FLAGS) $(OPT) $(d0library)/dbl3/general/d3unit.f ;\
	mv d3unit.o $(SCRATCH)/a2/d3unit.o ;\
	)
$(d0root)/test/dbl3/d0dbl3.a(xd3utop.o):\
  $(d0library)/dbl3/general/d3utop.f
	(cd $(d0root);\
	$(F77) $(F77FLAGS) $(OPT) $(d0library)/dbl3/general/d3utop.f ;\
	mv d3utop.o $(SCRATCH)/a2/d3utop.o ;\
	)
$(d0root)/test/dbl3/d0dbl3.a(xd3uxh.o):\
  $(d0library)/dbl3/general/d3uxh.f
	(cd $(d0root);\
	$(F77) $(F77FLAGS) $(OPT) $(d0library)/dbl3/general/d3uxh.f ;\
...
$(d0root)/test/dbl3/d0dbl3.a(xdbmctoh.o):\
  ...
  $(d0library)/params/byte_order.params
	(cd $(d0root);\
	$(F77) $(F77FLAGS) $(OPT) $(d0library)/dbl3/general/dbmctoh.f ;\
	mv dbmctoh.o $(SCRATCH)/a2/dbmctoh.o ;\
	)
$(d0root)/test/dbl3/d0dbl3.a(xdbmu_enddm.o):\
  $(d0library)/dbl3/general/dbmu_enddm.f
	(cd $(d0root);\
	$(F77) $(F77FLAGS) $(OPT) $(d0library)/dbl3/general/dbmu_enddm.f ;\
	mv dbmu_enddm.o $(SCRATCH)/a2/dbmu_enddm.o ;\
	)
$(d0root)/test/dbl3/d0dbl3.a(xdbmu_endhv.o):\
  $(d0library)/dbl3/general/dbmu_endhv.f
	(cd $(d0root);\
	$(F77) $(F77FLAGS) $(OPT) $(d0library)/dbl3/general/dbmu_endhv.f ;\
...
$(d0root)/test/dbl3/d0dbl3.a(xdbmu_getdm.o):\
  ...
  $(d0library)/inc/zebstp.inc
	(cd $(d0root);\
	$(F77) $(F77FLAGS) $(OPT) $(d0library)/dbl3/general/dbmu_getdm.f ;\
...
$(d0root)/test/dbl3/d0dbl3.a(xdbmu_gethv.o):\
  ...
  $(d0library)/inc/zebstp.inc
	(cd $(d0root);\
	$(F77) $(F77FLAGS) $(OPT) $(d0library)/dbl3/general/dbmu_gethv.f ;\
	mv dbmu_gethv.o $(SCRATCH)/a2/dbmu_gethv.o ;\
	)
$(d0root)/test/dbl3/d0dbl3.a(xdbmu_gtfile.o):\
  $(d0library)/dbl3/general/dbmu_gtfile.f
	(cd $(d0root);\
	$(F77) $(F77FLAGS) $(OPT) $(d0library)/dbl3/general/dbmu_gtfile.f ;\
...
$(d0root)/test/dbl3/d0dbl3.a(xdbmu_unpdm.o):\
  ...
  $(d0library)/inc/zebstp.inc
	(cd $(d0root);\
	$(F77) $(F77FLAGS) $(OPT) $(d0library)/dbl3/general/dbmu_unpdm.f ;\
...
$(d0root)/test/dbl3/d0dbl3.a(xdbmu_unphv.o):\
  ...
  $(d0library)/inc/zebstp.inc
	(cd $(d0root);\
	$(F77) $(F77FLAGS) $(OPT) $(d0library)/dbl3/general/dbmu_unphv.f ;\
	mv dbmu_unphv.o $(SCRATCH)/a2/dbmu_unphv.o ;\
	)
$(d0root)/test/dbl3/d0dbl3.a(xdbuky.o):\
  $(d0library)/dbl3/general/dbuky.f
	(cd $(d0root);\
	$(F77) $(F77FLAGS) $(OPT) $(d0library)/dbl3/general/dbuky.f ;\
	mv dbuky.o $(SCRATCH)/a3/dbuky.o ;\
	)
$(d0root)/test/dbl3/d0dbl3.a(xdbume.o):\
  $(d0library)/dbl3/general/dbume.f
	(cd $(d0root);\
	$(F77) $(F77FLAGS) $(OPT) $(d0library)/dbl3/general/dbume.f ;\
