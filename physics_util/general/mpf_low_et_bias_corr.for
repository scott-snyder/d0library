...
C----------------------------------------------------------------------
     ...
     &        'QCD_JET_CORRECTION_RCP','F')
        ...
        IF (ier.EQ.0) THEN
          ...
          IF (ier.EQ.0) CALL ezget('MPF_BIAS7',bias7,ier)
          IF (ier.EQ.0) CALL ezget('MPF_BIAS7_MIN',bias7_min,ier)
          IF (ier.EQ.0) CALL ezget('MPF_BIAS7_MAX',bias7_max,ier)
          IF (ier.EQ.0) CALL ezget('MPF_BIAS5',bias5,ier)
          IF (ier.EQ.0) CALL ezget('MPF_BIAS5_MIN',bias5_min,ier)
          IF (ier.EQ.0) CALL ezget('MPF_BIAS5_MAX',bias5_max,ier)
          IF (ier.EQ.0) CALL ezget('MPF_BIAS3',bias3,ier)
          IF (ier.EQ.0) CALL ezget('MPF_BIAS3_MIN',bias3_min,ier)
          IF (ier.EQ.0) CALL ezget('MPF_BIAS3_MAX',bias3_max,ier)
          IF (ier.EQ.0) CALL ezget('MPF_BIAS1',bias1,ier)
          IF (ier.EQ.0) CALL ezget('MPF_BIAS1_MIN',bias1_min,ier)
          IF (ier.EQ.0) CALL ezget('MPF_BIAS1_MAX',bias1_max,ier)
C
