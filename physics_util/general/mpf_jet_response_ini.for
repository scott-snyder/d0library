...
C-
      ...
      CALL hbname_i(nt_id,'event',runnum,mpf_event_chform)
      CALL hbname(nt_id,'global',et_prtn,mpf_global_chform)
      CALL hbname_i(nt_id,'em_vec',n_emc,mpf_emvector_chform)
      CALL hbname_i(nt_id,'em_iso',nele2,mpf_emiso_chform)
      CALL hbname_i(nt_id,'em_qual',nele3,mpf_emquality_chform)
      CALL hbname_i(nt_id,'jet_algo',algo,mpf_jetalgo_chform)
      CALL hbname_i(nt_id,'jetinfo7',nj7,mpf_jetinfo7)
      CALL hbname_i(nt_id,'jetinfo5',nj5,mpf_jetinfo5)
      CALL hbname_i(nt_id,'jetinfo3',nj3,mpf_jetinfo3)
      CALL hbname_i(nt_id,'jetinfon',njn,mpf_jetinfon)
      CALL hbname_i(nt_id,'jetinfo1',nj1,mpf_jetinfo10)
      CALL hbname_i(nt_id,'jetinfot',njt,mpf_jetinfot)
