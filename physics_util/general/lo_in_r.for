...
C
      ...
      IF ( IER.EQ.0 ) THEN
        ...
        CALL EZPICK ('LO_RCP')
        CALL EZGET('NPTYPE',NPTYPE,IER)
        CALL EZGET('NGROUP',NGROUP,IER)
        CALL EZGET('NSET',NSET,IER)
        CALL EZGET('NFL',NFL,IER)
        CALL EZGET('LO',LO,IER)
        ...
        CALL EZGET('LIM_FLAG',LIMIT_FLAG,IER)
        CALL EZGET('FLAG',TRIPLE_DIFF_FLAG,IER)
