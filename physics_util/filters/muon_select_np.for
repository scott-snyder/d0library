...
C *** Muon id cuts
C
        CALL EZGET('DO_MUCTAG_CUT',DO_MUCTAG_CUT,IER)

        IF(DO_MUCTAG_CUT) THEN
          IF(IER.EQ.0)
     &      CALL EZGET('IFW2_BIT7_CUT',IFW2_BIT7_CUT,IER)
          IF(IER.EQ.0)
     &      CALL EZGET('IFW2_BIT8_CUT',IFW2_BIT8_CUT,IER)
        ENDIF
     ...
     &    CALL EZGET('DO_OCTANT_CUT',DO_OCTANT_CUT,IER)
        IF(DO_OCTANT_CUT) THEN
          IF(IER.EQ.0)
     &      CALL EZGET('IFW2_BIT9_CUT',IFW2_BIT9_CUT,IER)
        ENDIF
C
        IF(IER.EQ.0)
     &    CALL EZGET('DO_IFW4_CUT',DO_MUIFW4_CUT,IER)
        IF(DO_MUIFW4_CUT) THEN
          IF(IER.EQ.0)
     &      CALL EZGET('IFW4_CUT',IFW4_CUT,IER)
        ENDIF
C
        IF(IER.EQ.0)
     &    CALL EZGET('DO_IFW1_CUT',DO_MUIFW1_CUT,IER)
        IF(DO_MUIFW1_CUT) THEN
          IF(IER.EQ.0)
     &      CALL EZGET('IFW1_NOMISS_A',IFW1_CUT_A,IER)
          IF(IER.EQ.0)
     &      CALL EZGET('IFW1_NOMISS_B',IFW1_CUT_B,IER)
          IF(IER.EQ.0)
     &      CALL EZGET('IFW1_NOMISS_C',IFW1_CUT_C,IER)
        ENDIF
C
        IF(IER.EQ.0)
     &    CALL EZGET('DO_CDCUT',DO_MUCD_CUT,IER)
        IF(DO_MUCD_CUT) THEN
          IF(IER.EQ.0)
...
C
        IF(IER.EQ.0)
     &    CALL EZGET('DO_IMPACT_CUT',DO_IMPACT_CUT,IER)
