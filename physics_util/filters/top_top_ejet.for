...
C----------------------------------------------------------------------
      IF ( FIRST ) THEN
        ...
        IF (IER.EQ.0)THEN
          ...
          CALL EZGET('SELECT_EM_FILTERS',SELECT_EM_FILTERS,IER)
     ...
     &        STATUS)
          ...
          CALL EZGET('NJET_MIN',NJET_MIN,IER)
          CALL EZGET('JET_ETCUT',JET_ETCUT,IER)
          CALL EZGET('JET_ETACUT',JET_ETACUT,IER)
          CALL EZGET('MET_CUT',MET_CUT,IER)
          CALL EZGET('SELECT_GAMMA',SELECT_GAMMA,IER)
          CALL EZGET('EXPRESS_STREAMING',EXPRESS_STREAMING,IER)
          CALL EZRSET
        ELSE
