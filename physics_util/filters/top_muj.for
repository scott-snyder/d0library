...
C parameters for first (tight) muon
          ...
          IF (IER.EQ.0) CALL EZGET('IFW4_MJMUT', IFW4CUT1, IER)
          IF (IER.EQ.0) CALL EZGET('MUCTAG_MJMUT', COSREJ1, IER)
          IF (IER.EQ.0) CALL EZGET('XOCT_MJMUT', XOCT1, IER)
          IF (IER.EQ.0) CALL EZGET('IMP_RZ_MJMUT', CIMP_RZ1,IER)
          IF (IER.EQ.0) CALL EZGET('IMP_XY_MJMUT', CIMP_XY1, IER)
          IF (IER.EQ.0) CALL EZGET('CD_OR_MJMUT', NCD_OR1, IER)
...
C parameters for second (loose) muon
          ...
          IF (IER.EQ.0) CALL EZGET('MUCTAG_MJMUL', COSREJ2, IER)
          IF (IER.EQ.0) CALL EZGET('IFW4_MJMUL', IFW4CUT2, IER)
          IF (IER.EQ.0) CALL EZGET('XOCT_MJMUL', XOCT2, IER)
C parameters for jets
     ...
     &      JETS_MINET_WITHMET,IER)
          IF (IER.EQ.0) CALL EZGET('NJETS_MIN_WITHMUL',
     &      NJETS_MIN_WITHMUL,IER)
          IF (IER.EQ.0) CALL EZGET('NJETS_MIN_WITHMET',
     &      NJETS_MIN_WITHMET,IER)
C parameters for Missing ET
          IF (IER.EQ.0) CALL EZGET('PNUT',PNUT,IER)
