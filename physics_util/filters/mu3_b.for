...
C   Get parameters from MU3_B.RCP
       ...
       ENDIF
        ...
        CALL EZGET_l('CUTMRC',CUTMRC,IERR)
        CALL EZGET_l('CUTIFW',CUTIFW,IERR)
        CALL EZGET_l('CUTBDL',CUTBDL,IERR)
        CALL EZGET_l('CUTCDM',CUTCDM,IERR)
        CALL EZGET_l('CUTCAL',CUTCAL,IERR)
        CALL EZGET_l('CUTCOS',CUTCOS,IERR)
