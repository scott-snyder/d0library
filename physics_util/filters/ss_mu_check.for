      SUBROUTINE SS_MU_CHECK(LPMUO,GOOD_MUON1)
C----------------------------------------------------------------------
C-
...
C
      INTEGER LPMUO,JBIT
      INTEGER I20,I21,I22,I25,I26,I27,I28,I29,I30
C
      GOOD_MUON1=.FALSE.
C
      IF(LPMUO.GT.0) THEN
...
C
       GOOD_MUON1 = (I20.EQ.0).AND.(I22.EQ.0).AND.
     &   (I27.EQ.0).AND.(I29.EQ.0).AND.(I30.EQ.0).AND.
     &   (I21.EQ.0 .OR. I25.EQ.0)
