      integer function ez_get_float_array (param, ary, n_max,
     &                                     callers_name)
C----------------------------------------------------------------------
C-
C-   Purpose and Methods :
C-
C-     Fetch an array of floating-point values from SRCP.
C-
C-   Returned value  :
...
C----------------------------------------------------------------------
      ...
      external ez_array_length, ez_get_float_elt
C----------------------------------------------------------------------
      ...
      do i=1, arylen
        ary(i) = ez_get_float_elt (param, i, callers_name)
      enddo

      ez_get_float_array = arylen
  999 RETURN
      END
