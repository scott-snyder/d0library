...
C-   Updated   9-JUN-1994   Ian Adam - delete CAD_HEADER_CHECK_RESET call
C---------------------------------------------------------------------- 
      IMPLICIT NONE
C
...
C
     ...
     &        CELL_EN(IETA,IPHI,ILYR)+ENERGY*WGT
      ENDDO
C
C *** DROP THE CAEP BANKS AND ZERO PTCAEP ARRAY
C
      CALL CPTCAZ
