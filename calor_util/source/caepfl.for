...
C
     ...
     &        ' PROCESSING SKIPS CAEPFL','W')
          ...
          CALL EZGET_l('FILL_PTCAEP',DO_PTCAEP,IER)
          CALL EZGET_l('DO_ADDR_CHECK',DO_ADDR_CHECK,IER)
          CALL EZGET_i('OLD_CAEP',OLD_CAEP,IER)
          CALL EZGET_l('NEED_CAD1',NEED_CAD1,IER)
          CALL EZRSET
        ELSE
...
C
          ...
          CALL EZGET_l('NEED_CAD2',NEED_CAD2,IER)
