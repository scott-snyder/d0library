...
C
     ...
     &      'Unable to find bank CLEANTAU_RCP','F')
        ...
        CALL EZGET('NCELL_MAX',NCELL_MAX,IER)
        CALL EZGET('N90_MAX',N90_MAX,IER)
        ...
        CALL EZGET('NTRK_MAX',NTRK_MAX,IER)
        CALL EZGET('NTRK10_MAX',NTRK10_MAX,IER)
        CALL EZGET('NTRK10_20_MAX',NTRK10_20_MAX,IER)
        CALL EZGET('NTRK10_30_MAX',NTRK10_30_MAX,IER)
        CALL EZRSET
      ENDIF
C
      STATUS = 0
