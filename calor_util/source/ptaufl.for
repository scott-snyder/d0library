...
C
          ...
          CALL EZGET('MIN_NTRACK',MIN_NTRACK,IER)
          CALL EZGET('MAX_NTRACK',MAX_NTRACK,IER)
          ...
          CALL EZGET('USE_NEW_RMS',USE_NEW_RMS,IER)
          CALL EZGET('NEW_RMS_CUT',NEW_RMS_CUT,IER)
          CALL EZGET('DST',DST,IER)
          CALL EZGET('HST_VERIFY',HST_VERIFY,IER)
          CALL EZRSET
