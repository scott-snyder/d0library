...
C
      ...
      CALL FFKEY_i1('DECA',DECA,1,'INTEGER')
      CALL FFKEY_i1('DUCA',DUCA,1,'INTEGER')
      CALL FFKEY_i1('DCRY',DCRY,1,'INTEGER')
      CALL FFKEY_i1('DEAD',DEAD,1,'INTEGER')
C
      CALL FFKEY_r1('LOECUT',LOECUT,1,'REAL')
      CALL FFKEY_r1('HIECUT',HIECUT,1,'REAL')
      CALL FFKEY_r1('X0STEP',X0STEP,1,'REAL')
...
C
      CALL FFKEY_r1('EDRP',EDRPMAX,1,'REAL')
      CALL FFKEY_r1('WDRP',WDRPMAX,1,'REAL')
      EDRPMAX = .05
      WDRPMAX = 500.
C
      ENTRY PRT_FFICAL
