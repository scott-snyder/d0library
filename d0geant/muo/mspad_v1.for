      SUBROUTINE MSPAD_V1(IPLANE,ICL1,HITS,NINDX,INDX,IPAD)
C----------------------------------------------------------------------
...
c. S.Igarashi 25-Apr-91     change the subroutine name for version update.
C----------------------------------------------------------------------
      IMPLICIT NONE
C-                                                    
...
C- 
      ...
      REAL    HITS(NHDIM,NHMAX),XDIS,WIDTH1,WIDTH2,REFPT
...
C-
      ...
      ELSE
        ...
        IOE   = MOD (NPATT,2)
      ENDIF
C---  Calculate a Width of copper
C-
       IF (IOE .EQ. 0) THEN
         WIDTH1 =  COEFF*XFRAC + WIDC0
         WIDTH2 = -COEFF*XFRAC + WIDS0
       ELSE
         WIDTH1 = -COEFF*XFRAC + WIDC1
         WIDTH2 =  COEFF*XFRAC + WIDS1
       ENDIF
C---  Get a Pulse Height
C-
      IPULS1 = WIDTH1/(WIDTH1+WIDTH2) * MAXDIG
      IPULS2 = WIDTH2/(WIDTH1+WIDTH2) * MAXDIG
