      FUNCTION MSDRFT(X,ANGLE1)
C----------------------------------------------------------------------
C-
C-   Purpose and Methods : Drift time response funcion considering
C-                         the position resolution of 200 micron.
C-
C-   Returned value  : MSDRFT ; Drift time (nsec)
...
C----------------------------------------------------------------------
      ...
      REAL    X,ANGLE1,ANGLE,DRIFT1,DRIFT2,MSDRFT,RANDOM
...
C  Consider the position resolution of 200 micron.
      CALL NORRAN(RANDOM)
      X = X + 0.02 * RANDOM
      X = ABS(X)
C
   ...
   10   I=I+1
        IF(I.LT.ND_00) THEN
          IF(X.GE.X_00(I) .AND. X.LT.X_00(I+1))THEN
            DRIFT1=DRIFT_00(I)+(DRIFT_00(I+1)-DRIFT_00(I))
     &            *(X_00(I+1)-X)/(X_00(I+1)-X_00(I))
            GOTO 11
          ELSE 
            GOTO 10
          ENDIF
   ...
   12   I=I+1
        IF(I.LT.ND_05) THEN
          IF(X.GE.X_05(I) .AND. X.LT.X_05(I+1))THEN
            DRIFT2=DRIFT_05(I)+(DRIFT_05(I+1)-DRIFT_05(I))
   ...
   13   MSDRFT=DRIFT1+(DRIFT2-DRIFT1)*(ANGLE-0.)/5.
   ...
   20   I=I+1
        IF(I.LT.ND_05) THEN
          IF(X.GE.X_05(I) .AND. X.LT.X_05(I+1))THEN
            DRIFT1=DRIFT_05(I)+(DRIFT_05(I+1)-DRIFT_05(I))
     &            *(X-X_05(I))/(X_05(I+1)-X_05(I))
            GOTO 21
          ELSE 
            GOTO 20
   ...
   22   I=I+1
        IF(I.LT.ND_15) THEN
          IF(X.GE.X_15(I) .AND. X.LT.X_15(I+1))THEN
            DRIFT2=DRIFT_15(I)+(DRIFT_15(I+1)-DRIFT_15(I))
   ...
   23   MSDRFT=DRIFT1+(DRIFT2-DRIFT1)*(ANGLE-5.)/10.
   ...
   30   I=I+1
        IF(I.LT.ND_15) THEN
          IF(X.GE.X_15(I) .AND. X.LT.X_15(I+1))THEN
            DRIFT1=DRIFT_15(I)+(DRIFT_15(I+1)-DRIFT_15(I))
     &            *(X-X_15(I))/(X_15(I+1)-X_15(I))
            GOTO 31
          ELSE 
            GOTO 30
   ...
   32   I=I+1
        IF(I.LT.ND_25) THEN
          IF(X.GE.X_25(I) .AND. X.LT.X_25(I+1))THEN
            DRIFT2=DRIFT_25(I)+(DRIFT_25(I+1)-DRIFT_25(I))
   ...
   33   MSDRFT=DRIFT1+(DRIFT2-DRIFT1)*(ANGLE-15.)/10.
   ...
   40   I=I+1
        IF(I.LT.ND_25) THEN
          IF(X.GE.X_25(I) .AND. X.LT.X_25(I+1))THEN
            DRIFT1=DRIFT_25(I)+(DRIFT_25(I+1)-DRIFT_25(I))
     &            *(X-X_25(I))/(X_25(I+1)-X_25(I))
            GOTO 41
          ELSE 
            GOTO 40
   ...
   42   I=I+1
        IF(I.LT.ND_35) THEN
          IF(X.GE.X_35(I) .AND. X.LT.X_35(I+1))THEN
            DRIFT2=DRIFT_35(I)+(DRIFT_35(I+1)-DRIFT_35(I))
   ...
   43   MSDRFT=DRIFT1+(DRIFT2-DRIFT1)*(ANGLE-25.)/10.
   ...
   50   I=I+1
        IF(I.LT.ND_35) THEN
          IF(X.GE.X_35(I) .AND. X.LT.X_35(I+1))THEN
            DRIFT1=DRIFT_35(I)+(DRIFT_35(I+1)-DRIFT_35(I))
     &            *(X-X_35(I))/(X_35(I+1)-X_35(I))
            GOTO 51
          ELSE 
            GOTO 50
   ...
   52   I=I+1
        IF(I.LT.ND_45) THEN
          IF(X.GE.X_45(I) .AND. X.LT.X_45(I+1))THEN
            DRIFT2=DRIFT_45(I)+(DRIFT_45(I+1)-DRIFT_45(I))
   ...
   53   MSDRFT=DRIFT1+(DRIFT2-DRIFT1)*(ANGLE-35.)/10.
   ...
   60   I=I+1
        IF(I.LT.ND_45) THEN
          IF(X.GE.X_45(I) .AND. X.LT.X_45(I+1))THEN
            MSDRFT=DRIFT_45(I)+(DRIFT_45(I+1)-DRIFT_45(I))
     &            *(X-X_45(I))/(X_45(I+1)-X_45(I))
            GOTO 61
          ELSE 
            GOTO 60
