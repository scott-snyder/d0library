...
C---Select correct RCP bank and fill the common block
      ...
      ENDIF
C
      CALL EZGET_i('LEM_HOT',LEM_HOT,IER)
      IF (IER.NE.0) GOTO 900
      CALL EZGET_i('LJT_HOT',LJT_HOT,IER)
      IF (IER.NE.0) GOTO 900
      CALL EZGET_i('LEN_EM1',LEN_EM1,IER)
      IF (IER.NE.0) GOTO 900
      CALL EZGET_i('LEN_EM2',LEN_EM2,IER)
      IF (IER.NE.0) GOTO 900
      CALL EZGET_i('LEN_HD1',LEN_HD1,IER)
      IF (IER.NE.0) GOTO 900
      CALL EZGET_i('LEN_HD2',LEN_HD2,IER)
      IF (IER.NE.0) GOTO 900
