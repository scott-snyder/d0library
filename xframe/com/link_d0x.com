$!
$! @link_d0x file(s) [debug]            [debug] to debug, 
$!
$!   files must come BEFORE the debug keyword
$!
...
$   link'swit'/nonative_only/exe='deb'd0x 'p1',d0$xframe:'deb'd0x,-
'd0lib1','d0lib2','cernp',-
sys$input/opt
...
$   if mv.eqs."1.2"
$   then
$     link'swit'/exe='deb'd0x 'p1',d0$xframe:'deb'd0x,-
'd0lib1,'d0lib2','cernp',-
sys$input/opt
psect_attr=XMQMOTIF,noshr,lcl
sys$share:decw$mrmlibshr12/share
