...
C
      NQUANS = NQUANS+1
      QUANS(NQUANS) = Q(LCLUS+3)     !EX
      NAMQUANS(NQUANS) = 'EX'
      NQUANS = NQUANS+1
      QUANS(NQUANS) = Q(LCLUS+4)     !EY
      NAMQUANS(NQUANS) = 'EY'
      NQUANS = NQUANS+1
      QUANS(NQUANS) = Q(LCLUS+5)     !EZ
      NAMQUANS(NQUANS) = 'EZ'
      NQUANS = NQUANS+1
      ...
      NAMQUANS(NQUANS) = 'ET'
      NQUANS = NQUANS+1
      QUANS(NQUANS) = IETA_HOT(3)    !TOWER IETA OF HOTTEST CELL IN EM3
      NAMQUANS(NQUANS) = 'IETA'
      NQUANS = NQUANS+1
      QUANS(NQUANS) = IPHI_HOT(3)    !TOWER IPHI OF HOTTEST CELL IN EM3
      NAMQUANS(NQUANS) = 'IPHI'
      NQUANS = NQUANS+1
      ...
      NQUANS = NQUANS+1
      QUANS(NQUANS) = Q(LCLUS+23)           !X OF SHOWER CENTER
      NAMQUANS(NQUANS) = 'X COG'
      NQUANS = NQUANS+1
      QUANS(NQUANS) = Q(LCLUS+24)           !Y
      NAMQUANS(NQUANS) = 'Y COG'
      NQUANS = NQUANS+1
      QUANS(NQUANS) = Q(LCLUS+25)           !Z
      NAMQUANS(NQUANS) = 'Z COG'
      NQUANS = NQUANS+1
      QUANS(NQUANS) = NCELLS
      NAMQUANS(NQUANS) = 'NCELLS'
      NQUANS = NQUANS+1
      QUANS(NQUANS) = Q(LCLUS+15)           !TOTAL E CORECLUS
      NAMQUANS(NQUANS) = 'CORE ETOT'
      NQUANS = NQUANS+1
      QUANS(NQUANS) = Q(LCLUS+16)           !TOTAL E IS0CLUS
      NAMQUANS(NQUANS) = 'ISOL ETOT'
      NQUANS = NQUANS+1
