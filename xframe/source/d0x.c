...
#include "/d0lib/scratch/xframe/source/d0x.h"
...
{"mancontrol", (caddr_t)mancontrol},
{"manutil", (caddr_t)manutil},
{"umutil", (caddr_t)umutil},
{"umcontrol", (caddr_t)umcontrol},
...
VUIT_Manage("files_bull");
VUIT_Manage("control_bull");
VUIT_Manage("d0_bull");
...
unsigned long	*reason;
{
VUIT_Unmanage("files_bull");
}

void mancontrol (w, tag, reason)
Widget		w;
int		*tag;
unsigned long	*reason;
{
...

void umutil (w, tag, reason)
Widget		w;
int		*tag;
unsigned long	*reason;
{
VUIT_Unmanage("d0_bull");
}

void umcontrol (w, tag, reason)
Widget		w;
int		*tag;
unsigned long	*reason;
{
VUIT_Unmanage("control_bull");
}

