...
C-                                                                              
C-                                                                              
C-    No routine was provided for the package: L2_COMPARE                       
C-                                                                              
      RETURN                                                                    
      END                                                                       
C-                                                                              
...
C-                                                                              
      IF ( (PBD_FLAG_VALUE( 1))                                                 
     &    ) THEN                                                                
         IF (.NOT. L2_COMPARE()) THEN                                           
            USREVT = .FALSE.                                                    
            MESSID = '!L2_COMPARE is false.'                                    
            CALLER = 'L2_COMPARE'                                               
...
C-                                                                              
      CHARACTER*32 MESSID,CALLER                                                
      CHARACTER*80 MESSAG                                                       
      LOGICAL L2_COMPARE_INI                                                    
      EXTERNAL L2_COMPARE_INI                                                   
      LOGICAL PBD_FLAG_VALUE( 1)                                                
      CHARACTER*32 PBD_FLAG_NAME( 1)                                            
      INTEGER PBD_FLAG_MAX                                                      
      COMMON /PBD_COMMON/ PBD_FLAG_VALUE,PBD_FLAG_NAME,PBD_FLAG_MAX             
...
C-                                                                              
      IF ( (PBD_FLAG_VALUE( 1))                                                 
     &    ) THEN                                                                
         IF (.NOT. L2_COMPARE_INI()) THEN                                       
            USRINI = .FALSE.                                                    
            MESSID = '!L2_COMPARE_INI is false.'                                
            CALLER = 'L2_COMPARE_INI'                                           
...
C-                                                                              
      CHARACTER*32 MESSID,CALLER                                                
      CHARACTER*80 MESSAG                                                       
      LOGICAL L2_COMPARE_DIA                                                    
      EXTERNAL L2_COMPARE_DIA                                                   
      LOGICAL PBD_FLAG_VALUE( 1)                                                
      CHARACTER*32 PBD_FLAG_NAME( 1)                                            
      INTEGER PBD_FLAG_MAX                                                      
      COMMON /PBD_COMMON/ PBD_FLAG_VALUE,PBD_FLAG_NAME,PBD_FLAG_MAX             
...
C-                                                                              
      IF ( (PBD_FLAG_VALUE( 1))                                                 
     &    ) THEN                                                                
         IF (.NOT. L2_COMPARE_DIA()) THEN                                       
            USDIAL = .FALSE.                                                    
            CALLER = 'L2_COMPARE_DIA'                                           
...
C-                                                                              
      CHARACTER*32 MESSID,CALLER                                                
      CHARACTER*80 MESSAG                                                       
      LOGICAL L2_COMPARE_SUM                                                    
      EXTERNAL L2_COMPARE_SUM                                                   
      LOGICAL PBD_FLAG_VALUE( 1)                                                
      CHARACTER*32 PBD_FLAG_NAME( 1)                                            
      INTEGER PBD_FLAG_MAX                                                      
      COMMON /PBD_COMMON/ PBD_FLAG_VALUE,PBD_FLAG_NAME,PBD_FLAG_MAX             
...
C-                                                                              
      IF ( (PBD_FLAG_VALUE( 1))                                                 
     &    ) THEN                                                                
         IF (.NOT. L2_COMPARE_SUM()) THEN                                       
            USRSSM = .FALSE.                                                    
            CALLER = 'L2_COMPARE_SUM'                                           
            MESSAG = 'This error is ignored'                                    
            CALL ERRMSG(MESSID,CALLER,MESSAG,'I')                               
         END IF                                                                 
      END IF                                                                    
