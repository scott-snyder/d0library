...
C-   Updated  28-JUL-1992   Qizhong Li-Demarteau  to used for level 2 
C-
C----------------------------------------------------------------------
      IMPLICIT NONE
C
...
C
        ...
        DO 20 INDEX = 0, 2
          ...
          NPULSE(WIRE) = 0
          CALL L2_CDPULS(NPULSE(WIRE) , HITLST(1,NHITS+1), MXHTOT-NHITS)
          ...
          IF (INDEX .EQ. 0) THEN
            ...
            NPULS1(WIRE) = 0
            CALL L2_CDPULS
     &        (NPULS1(WIRE),HITLS1(1,NHITS1+1),MXHTOT-NHITS1)
...
C
        ...
        DO 30 INDEX = 1, 2
          ...
          CALL L2_CDPULS(NPULS1(WIRE),HITLS1(1,NHITS1+1),MXHTOT-NHITS1)
          NHITS1 = NHITS1 + NPULS1(WIRE)
  30    CONTINUE
