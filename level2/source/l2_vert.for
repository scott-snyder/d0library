...
C
      IF (FIRST) THEN
        ...
        CALL EZPICK('L2_VERT')
        CALL EZGET('USE_NOMINAL',USE_NOMINAL,IER)
        CALL EZGET('USE_FASTZ',USE_FASTZ,IER)
        CALL EZGET('USE_CDC',USE_CDC,IER)
        CALL EZGET('NOMINAL_VERTEX',NOMINAL_VERTEX,IER)
        CALL EZGET('USE_CDC_VERTEX_FOR',USE_CDC_VERTEX_FOR,IER)
        CALL EZRSET
