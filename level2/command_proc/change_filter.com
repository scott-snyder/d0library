...
$!
$  TEST = F$SEARCH("RUN_FILTER_0000001.DAT")
$  IF TEST.EQS."" 
$    THEN GOTO NOfilt
$  ENDIF
$  SAY "Found old RUN_FILTER_0000001.DAT in this directory."
...
$  GOTO FOUNDfilt
$NOfilt:
$  SAY " Copying RUN_FILTER_0000001.DAT for the ''p1' Trigger Set from D0$LEVEL2"
$  COPY D0$LEVEL2$L2SIM:FILTER_'p1'.DAT         'DEF_DIR'RUN_FILTER_0000001.DAT
...
$  COPY D0$LEVEL2$L2SIM:'p1'_TRIG_FILT.INFO     'DEF_DIR'TRIG_FILT_0000000.INFO
$  COPY D0$LEVEL2$L2SIM:'p1'_TRIGGER.RES        'DEF_DIR'TRIGGER.RES
$!  PURGE MU_TRIGGER.INFO
$!  PURGE TRIGGER.INFO
$!  PURGE TRIG_FILT_RUN.INFO
$!  PURGE RCP_0000001.DAT
$!  PURGE RCP_0000001.ZDAT
$!  PURGE RUN_FILTER_0000001.DAT
$FOUNDfilt:
$!
$EXIT:
$   EXIT
