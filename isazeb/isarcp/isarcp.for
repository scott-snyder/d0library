...
C
      CALL EZGET_l('DO_MASS_DISTRIBUTION',DO_MASS_DISTRIBUTION,IER)
      CALL EZGET_l('DO_MASS_CHECK',DO_MASS_CHECK,IER)
      CALL EZGET_i('OUTPUT_UNIT',ITEVT,IER)
      CALL EZGET_i('PRINT_EVENT_NUMBER',PRINT_EVENT,IER)
C
      OK = ISARCP_BEG()
