...
C
      ...
      DATA VCXMNS,VCXMXS,VCYMNS,VCYMXS /-1.,1.,-1.,1./  ! (JVSPAC)
C
...
C  CHARACTER DEFAULTS
      DATA IPATH ,IFONTC,IHJUST,IVJUST        /0,0,0,0/
...
C
      ...
      DATA IUBASE/40/                !BASE UNIT NUMBER FOR HARDCOPY FILES
C
      DI3INI = 1
