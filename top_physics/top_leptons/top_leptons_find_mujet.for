...
C
        ...
        IF (IER.EQ.0) CALL EZGET('LJ_NOMUON_MAX',NOMUON_MAX,IER)
        IF (IER.EQ.0) CALL EZGET('LJ_DO_ISOL_CUT',DO_ISOL_CUT,IER)
        IF (IER.EQ.0) CALL EZGET('LJ_NOMU_ISO_MIN',NOMU_ISO_MIN,IER)
        IF (IER.EQ.0) CALL EZGET('LJ_NOMU_ISO_MAX',NOMU_ISO_MAX,IER)
        IF (IER.EQ.0) CALL EZGET('LJ_MUON2_PTMIN',MUON2_PTMIN,IER)
        IF (IER.EQ.0) CALL EZGET('LJ_NOMU_NONISO_MIN',NOMU_NONISO_MIN,
     1      IER)
        IF (IER.EQ.0) CALL EZGET('LJ_NOMU_NONISO_MAX',NOMU_NONISO_MAX,
     1      IER)
        ...
        IF (IER.EQ.0) CALL EZGET('LJ_JET_MULT_MAX',NOJT_MAX,IER)
