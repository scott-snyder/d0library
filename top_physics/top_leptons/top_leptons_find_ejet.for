      SUBROUTINE TOP_LEPTONS_FIND_EJET(IFGOOD,NOMU,NOEL,NOPH,
     1  NOJT,MET_VEC)
C----------------------------------------------------------------------
C-
C-   Purpose and Methods : event search routine for top->e+jets decays
C-
C-   Inputs  : 
...
C-                          Good_Jet routines
C-   Modified 13-Aug-1993   Herbert Greenlee
C-                          Add call to top_leptons_find_isolel for electron
C-                          Change some RCP parameters.
C-   Modified  4-Dec-1993   Redundant variables removed
C-
C----------------------------------------------------------------------
      IMPLICIT NONE
C
...
C
        ...
        IF (IER.EQ.0) CALL EZGET('LJ_MUON1_DRMAX',MUON1_DRMAX,IER)
