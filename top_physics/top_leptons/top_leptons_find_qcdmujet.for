...
C
        ...
        IF (IER.EQ.0) CALL EZGET_i('MJQCD_NOMUON_MIN',NOMUON_MIN,IER)
        IF (IER.EQ.0) CALL EZGET_i('MJQCD_NOMUON_MAX',NOMUON_MAX,IER)
        IF (IER.EQ.0) CALL EZGET_l('MJQCD_DO_ISOL_CUT',DO_ISOL_CUT,IER)
        IF (IER.EQ.0) CALL EZGET_i('MJQCD_NOMU_ISO_MIN',NOMU_ISO_MIN,
     &       IER)
        IF (IER.EQ.0) CALL EZGET_i('MJQCD_NOMU_ISO_MAX',NOMU_ISO_MAX,
     &       IER)
        IF (IER.EQ.0) CALL EZGET('MJQCD_MUON2_PTMIN',MUON2_PTMIN,IER)
        IF (IER.EQ.0) CALL EZGET_i('MJQCD_NOMU_NONISO_MIN',
     1    NOMU_NONISO_MIN,IER)
        IF (IER.EQ.0) CALL EZGET_i('MJQCD_NOMU_NONISO_MAX',
     1    NOMU_NONISO_MAX,IER)
        ...
        IF (IER.EQ.0) CALL EZGET_i('MJQCD_JET_MULT_MIN',NOJT_MIN,IER)
        ...
        IF (IER.EQ.0) CALL EZGET_i('MJQCD_JET_MULT_MAX',NOJT_MAX,IER)
