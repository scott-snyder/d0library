      SUBROUTINE TOP_LEPTONS_FIND_WPAIR_EE(IFGOOD,NOMU,NOEL,NOPH,
     1  NOJT,MET_VEC)
C----------------------------------------------------------------------
C-
C-   Purpose and Methods : event search routine to look for WPAIR->e e 
C-                                  event candidates
C-
C-   Inputs  : 
...
C-   Modified 11-May-1993   (HTD) WPair version created.
...
C
      INTEGER NOMU,NOEL,NOPH,NOJT,NOJT_MIN,IV,IER
...
C
      ...
      REAL MISSET_MIN_CALO,MISSET_MIN_CORR,MET_VEC(3)
      REAL DPHI_MAX_LEP12,MISSET_CALO,MISSET_CORR
...
C
        CALL EZGET('MAX_DPHI_L12',DPHI_MAX_LEP12,IER)
...
C
C *** Look for two isolated electrons above threshold
C
...
C
     ...
     1      JETS_EX,JETS_EY,JETS_PHI,JETS_ETA,IER)
