      SUBROUTINE TOP_LEPTONS_UTIL_SPHERICITY(NDIM,NMAX,PV,POUT)
C----------------------------------------------------------------------
C-
...
C-   Updated  11-JUL-1993  Name change to add to Top_Leptons
C-
C----------------------------------------------------------------------
      IMPLICIT NONE
C
