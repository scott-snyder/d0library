...
C
      ...
      REAL VECT(4),VECT2(4),VMOD,MT3_CLUS
...
C
        ...
        CALL EZGET_l('PLOT_ELECTRON_HIST',ELECTRON_HIST,IER)
        IF(IER.EQ.0) CALL EZGET_l('PLOT_MUON_HIST',MUON_HIST,IER)
        IF(IER.EQ.0) CALL EZGET_l('PLOT_DIMUON_HIST',DIMUON_HIST,IER)
        IF(IER.EQ.0) CALL EZGET_l('PLOT_MUJET_HIST',MUJET_HIST,IER)
        IF(IER.EQ.0) CALL EZGET_l('PLOT_PHOTON_HIST',PHOTON_HIST,IER)
