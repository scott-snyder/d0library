...
C
     ...
     &      ' ','W')
        ...
        CALL EZGET_l('ALGO1',ALGO_T(1),IER)
        CALL EZGET_l('ALGO2',ALGO_T(2),IER)
        CALL EZGET_l('ALGO3',ALGO_T(3),IER)
        CALL EZGET('CORR_MISET',CORR_MET,IER)
        CALL EZGET_l('CORRJ',JCORR,IER)
        CALL EZGET_l('DO_DUMPS',DODUMPS,IER)
        CALL EZGET_i('ICHOICE',ICH,IER)
        CALL EZRSET
        FIRST=.FALSE.
      ENDIF
      GOTO 999
