...
C
      IF( first ) THEN
        ...
        CALL EZGET('LEPTON1',LEPTON1,IER)
        CALL EZGET('LEPTON2',LEPTON2,IER)
        CALL EZGET('JET1',JET1,IER)
        CALL EZGET('JET2',JET2,IER)
        CALL EZGET('JET3',JET3,IER)
        CALL EZGET('PNUT',PNUT,IER)
        CALL EZGET('WMASS',WMASS,IER)
        CALL EZGET('DO_EXACT',DO_EXACT,IER)
        CALL EZGET('TMASS_LO',TMASS_LO,IER)
        CALL EZGET('TMASS_HI',TMASS_HI,IER)
