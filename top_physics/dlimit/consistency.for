...
C
        CALL EZGET('FLUCTUATE_MASS',FLUCTUATE_MASS,IER)
        CALL EZGET('DO_CONTOUR',DO_CONTOUR,IER)
C
        CALL EZGET('BRLO',BRLO,IER)
        CALL EZGET('NBR',NBR,IER)
        CALL EZGET('BRSTEP',BRSTEP,IER)
C
        CALL EZGET('XMLO',XMLO,IER)
        CALL EZGET('XNMASS',XNMASS,IER)
        CALL EZGET('XMSTEP',XMSTEP,IER)
C
        CALL EZGET('MLO',MLO,IER)
        CALL EZGET('NMASS',NMASS,IER)
        CALL EZGET('MSTEP',MSTEP,IER)
        CALL EZGET('CLO',CLO,IER)
        CALL EZGET('NCROSS',NCROSS,IER)
        CALL EZGET('CSTEP',CSTEP,IER)
        CALL EZGET('NEVTOT',NEVTOT,IER)
        CALL EZGET('TOT_BCKGD',TOT_BCKGD,IER)
        CALL EZGET('BCKGD_ERR',BCKGD_ERR,IER)
        CALL EZGET('LUMIN',LUMIN,IER)
        CALL EZGET('ELUMIN',ELUMIN,IER)
        CALL EZGET('BCKGD',BCKGD,IER)
        CALL EZGET('EBCKGD',EBCKGD,IER)
        CALL EZGET('NEVS',NEVS,IER)
        CALL EZGET('EXSECT',EXSECT,IER)
        CALL EZGET('NEXPGEN',NEXPGEN,IER)
