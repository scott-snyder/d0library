...
C
      ...
      ENDIF
*
      CALL EZGET('COLUMN_WISE',COLUMN_WISE,IER)
*
...
C
      CALL EZGET('NUMBER_OF_SMEARS',NSMEAR,IER)
      CALL EZGET('MET_SMEAR_RANGE',MET_SMEAR_RANGE,IER)
      CALL EZGET('ZERO_MISSING_ET',ZERO_MET,IER)
      CALL EZRSET
C
      CALL EZPICK('TOP_FIT_RCP')
      CALL EZSET('JET_ET_CUT',JET_ET_CUT,IER)
      CALL EZSET('ELECTRON_RESOLN',ELECTRON_RESOLN_S,IER)
      CALL EZSET('MUON_RESOLN',MUON_RESOLN_S,IER)
      CALL EZSET('JET_RESOLN',JET_RESOLN_S,IER)
      CALL EZSET('REST_RESOLN',REST_RESOLN_S,IER)
C
      CALL EZSET('ELEC_ETA_RESOLN',ELEC_ETA_RESOLN_S,IER)
      CALL EZSET('MUON_ETA_RESOLN',MUON_ETA_RESOLN_S,IER)
      CALL EZSET('JET_ETA_RESOLN',JET_ETA_RESOLN_S,IER)
C
      CALL EZSET('ELEC_PHI_RESOLN',ELEC_PHI_RESOLN_S,IER)
      CALL EZSET('MUON_PHI_RESOLN',MUON_PHI_RESOLN_S,IER)
      CALL EZSET('JET_PHI_RESOLN',JET_PHI_RESOLN_S,IER)
      CALL EZRSET
C
C ********************************************
C ****  Open HBOOK files
