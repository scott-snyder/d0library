...
*HEAD 21
     ...
     +    ,RMIFLAG,CL_CAL')
*ELEC 12
        CALL HBNAME(ID2,B_NAME2,EE1,
     &    ' EE1,ETE1,THE1,ETAE1,PHIE1,RIETAE1')
C        CALL HBNAME(ID2,B_NAME2,EE2,
C     &    'EE2,ETE2
C     +    ,THE2,ETAE2,PHIE2,RIETAE2')
*TRAK*4
        CALL HBNAME(ID2,B_NAME2,DET1 ,'DET1,DEDX1')
C        CALL HBNAME(ID2,B_NAME2,DET2 ,'DET2,DEDX2')
*CORRECTED JETS*15
        CALL HBNAME(ID2,B_NAME2,EJC51,
     &    'EJC51,ETJC51,ETAJC51,EJC52,ETJC52,ETAJC52,EJC53,ETJC53
     +    ,ETAJC53,EJC54,ETJC54,ETAJC54,EJC55,ETJC55,ETAJC55')
*MET*16
        CALL HBNAME(ID2,B_NAME2,RMETC1,
     &    ' RMETC1,RMETPHIC1,RMETC2
     +    ,RMETPHIC2')
*OTHERS*8
        CALL HBNAME(ID2,B_NAME2,BAD_ELE,
