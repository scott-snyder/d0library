...
C----------------------------------------------------------------------
      IF( first ) THEN
        ...
        CALL EZGET_i('MINUIT_INP_UNIT',MNINP,IER)
        CALL EZGET_i('MINUIT_OUT_UNIT',MNOUT,IER)
        CALL EZGET_i('MINUIT_SAV_UNIT',MNSAV,IER)
...
C
        CALL EZGET_l('INTERACTIVE',INTERACT,IER)
        IER = 0
        NCOMMANDS = 0
C
        DO WHILE(IER.EQ.0)
