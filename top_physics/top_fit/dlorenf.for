      SUBROUTINE DLORENF (U,PS,PI,PF)
C----------------------------------------------------------------------
C-
C-   Purpose and Methods : Forward Lorentz Transforms a 4 vector PI
C-                         to a rest frame specified by PS(4) of mass U.
C-
C-   Inputs  : U=mass of rest frame 4 vector
C-             PS(1:4) = 4 vector of rest frame particle in lab
C-             PI(1:4) = 4 vector of particle in lab
C-   Outputs : PF(1:4) = 4 vector of particle Pi in rest frame of PS
C-   Controls: 
C-
